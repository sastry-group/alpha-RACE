...
class Metaclass_SphereAttributes(type):
    """Metaclass of message 'SphereAttributes'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sphere_attributes
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sphere_attributes
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sphere_attributes
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sphere_attributes
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sphere_attributes
...
class SphereAttributes(metaclass=Metaclass_SphereAttributes):
    """Message class 'SphereAttributes'."""
