...
bool foxglove_msgs__msg__sphere_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._sphere_primitive.SpherePrimitive", full_classname_dest, 51) == 0);
  }
  foxglove_msgs__msg__SpherePrimitive * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of SpherePrimitive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._sphere_primitive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SpherePrimitive");
