...
bool foxglove_msgs__msg__line_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._line_marker.LineMarker", full_classname_dest, 41) == 0);
  }
  foxglove_msgs__msg__LineMarker * ros_message = _ros_message;
  {  // type
...
{
  /* NOTE(esteve): Call constructor of LineMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._line_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LineMarker");
