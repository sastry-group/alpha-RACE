...
class Metaclass_SphereListMarker(type):
    """Metaclass of message 'SphereListMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__sphere_list_marker
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__sphere_list_marker
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__sphere_list_marker
            cls._TYPE_SUPPORT = module.type_support_msg__msg__sphere_list_marker
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__sphere_list_marker
            ...
            from foxglove_msgs.msg import SphereAttributes
            if SphereAttributes.__class__._TYPE_SUPPORT is None:
                SphereAttributes.__class__.__import_type_support__()
...
class SphereListMarker(metaclass=Metaclass_SphereListMarker):
    """Message class 'SphereListMarker'."""
    ...
    _fields_and_field_types = {
        ...
        'attributes': 'sequence<foxglove_msgs/SphereAttributes>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['foxglove_msgs', 'msg'], 'SphereAttributes')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, str) and
                 not isinstance(value, UserString) and
                 all(isinstance(v, SphereAttributes) for v in value) and
                 True), \
                "The 'attributes' field must be a set or sequence and each value of type 'SphereAttributes'"
