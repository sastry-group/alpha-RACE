...
bool foxglove_msgs__msg__model_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._model_marker.ModelMarker", full_classname_dest, 43) == 0);
  }
  foxglove_msgs__msg__ModelMarker * ros_message = _ros_message;
  {  // pose
  ...
  {  // use_embedded_materials
    PyObject * field = PyObject_GetAttrString(_pymsg, "use_embedded_materials");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->use_embedded_materials = (Py_True == field);
    Py_DECREF(field);
  }
  {  // url
  ...
  {  // mime_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "mime_type");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->mime_type, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of ModelMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._model_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelMarker");
  ...
  {  // use_embedded_materials
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->use_embedded_materials ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "use_embedded_materials", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // mime_type
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->mime_type.data,
      strlen(ros_message->mime_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "mime_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
