...
class Metaclass_TextAnnotation(type):
    """Metaclass of message 'TextAnnotation'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__text_annotation
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__text_annotation
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__text_annotation
            cls._TYPE_SUPPORT = module.type_support_msg__msg__text_annotation
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__text_annotation
...
class TextAnnotation(metaclass=Metaclass_TextAnnotation):
    """Message class 'TextAnnotation'."""
    ...
    _fields_and_field_types = {
        ...
        'text': 'string',
        'font_size': 'double',
        'text_color': 'foxglove_msgs/Color',
        'background_color': 'foxglove_msgs/Color',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from foxglove_msgs.msg import Color
        self.text_color = kwargs.get('text_color', Color())
        from foxglove_msgs.msg import Color
        self.background_color = kwargs.get('background_color', Color())
    ...
    def text_color(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'text_color' field must be a sub message of type 'Color'"
        self._text_color = value

    @builtins.property
    def background_color(self):
        """Message field 'background_color'."""
    ...
    def background_color(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Color), \
                "The 'background_color' field must be a sub message of type 'Color'"
