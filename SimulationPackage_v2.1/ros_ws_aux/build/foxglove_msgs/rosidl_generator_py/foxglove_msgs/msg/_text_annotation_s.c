...
bool foxglove_msgs__msg__text_annotation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._text_annotation.TextAnnotation", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__TextAnnotation * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // position
    ...
    if (!foxglove_msgs__msg__point2__convert_from_py(field, &ros_message->position)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // text_color
    ...
    if (!foxglove_msgs__msg__color__convert_from_py(field, &ros_message->text_color)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
  ...
  {  // background_color
    PyObject * field = PyObject_GetAttrString(_pymsg, "background_color");
    if (!field) {
      return false;
    }
    if (!foxglove_msgs__msg__color__convert_from_py(field, &ros_message->background_color)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of TextAnnotation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._text_annotation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TextAnnotation");
  ...
  {  // position
    PyObject * field = NULL;
    field = foxglove_msgs__msg__point2__convert_to_py(&ros_message->position);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // text_color
    PyObject * field = NULL;
    field = foxglove_msgs__msg__color__convert_to_py(&ros_message->text_color);
    if (!field) {
      return NULL;
    }
    {
  ...
  {  // background_color
    PyObject * field = NULL;
    field = foxglove_msgs__msg__color__convert_to_py(&ros_message->background_color);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "background_color", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
