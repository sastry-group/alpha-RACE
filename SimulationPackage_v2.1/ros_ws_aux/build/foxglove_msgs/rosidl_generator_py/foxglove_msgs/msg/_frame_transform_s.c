...
bool foxglove_msgs__msg__frame_transform__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._frame_transform.FrameTransform", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__FrameTransform * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // parent_frame_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "parent_frame_id");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->parent_frame_id, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of FrameTransform */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._frame_transform");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "FrameTransform");
  ...
  {  // parent_frame_id
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->parent_frame_id.data,
      strlen(ros_message->parent_frame_id.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "parent_frame_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
