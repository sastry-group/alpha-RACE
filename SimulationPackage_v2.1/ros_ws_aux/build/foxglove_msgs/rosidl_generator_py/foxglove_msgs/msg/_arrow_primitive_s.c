...
bool foxglove_msgs__msg__arrow_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._arrow_primitive.ArrowPrimitive", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__ArrowPrimitive * ros_message = _ros_message;
  {  // pose
  ...
  {  // shaft_length
    PyObject * field = PyObject_GetAttrString(_pymsg, "shaft_length");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->shaft_length = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // shaft_diameter
...
{
  /* NOTE(esteve): Call constructor of ArrowPrimitive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._arrow_primitive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArrowPrimitive");
  ...
  {  // shaft_length
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->shaft_length);
    {
      int rc = PyObject_SetAttrString(_pymessage, "shaft_length", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
