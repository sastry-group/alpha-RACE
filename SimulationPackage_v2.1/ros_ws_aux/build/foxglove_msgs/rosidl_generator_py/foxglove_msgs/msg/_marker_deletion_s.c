...
bool foxglove_msgs__msg__marker_deletion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._marker_deletion.MarkerDeletion", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__MarkerDeletion * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of MarkerDeletion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._marker_deletion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MarkerDeletion");
