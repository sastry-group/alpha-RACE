...
bool foxglove_msgs__msg__location_fix__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._location_fix.LocationFix", full_classname_dest, 43) == 0);
  }
  foxglove_msgs__msg__LocationFix * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of LocationFix */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._location_fix");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LocationFix");
