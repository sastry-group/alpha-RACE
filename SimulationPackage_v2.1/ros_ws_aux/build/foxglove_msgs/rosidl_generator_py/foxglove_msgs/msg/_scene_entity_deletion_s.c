...
bool foxglove_msgs__msg__scene_entity_deletion__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._scene_entity_deletion.SceneEntityDeletion", full_classname_dest, 60) == 0);
  }
  foxglove_msgs__msg__SceneEntityDeletion * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of SceneEntityDeletion */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._scene_entity_deletion");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SceneEntityDeletion");
