...
class Metaclass_CylinderMarker(type):
    """Metaclass of message 'CylinderMarker'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__cylinder_marker
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__cylinder_marker
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__cylinder_marker
            cls._TYPE_SUPPORT = module.type_support_msg__msg__cylinder_marker
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__cylinder_marker
...
class CylinderMarker(metaclass=Metaclass_CylinderMarker):
    """Message class 'CylinderMarker'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.bottom_radius = kwargs.get('bottom_radius', float())
        self.top_radius = kwargs.get('top_radius', float())
    ...
    def __eq__(self, other):
        ...
        if self.pose != other.pose:
            return False
        if self.bottom_radius != other.bottom_radius:
            return False
        if self.top_radius != other.top_radius:
            return False
    ...
    def bottom_radius(self, value):
        if __debug__:
            assert \
                ...
                "The 'bottom_radius' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'bottom_radius' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._bottom_radius = value

    @builtins.property
    def top_radius(self):
        """Message field 'top_radius'."""
    ...
    def top_radius(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'top_radius' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'top_radius' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
