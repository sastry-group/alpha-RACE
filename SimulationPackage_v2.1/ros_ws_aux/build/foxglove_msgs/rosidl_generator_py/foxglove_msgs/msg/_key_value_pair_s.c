...
bool foxglove_msgs__msg__key_value_pair__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._key_value_pair.KeyValuePair", full_classname_dest, 46) == 0);
  }
  foxglove_msgs__msg__KeyValuePair * ros_message = _ros_message;
  {  // key
...
{
  /* NOTE(esteve): Call constructor of KeyValuePair */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._key_value_pair");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "KeyValuePair");
