...
bool foxglove_msgs__msg__compressed_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._compressed_image.CompressedImage", full_classname_dest, 51) == 0);
  }
  foxglove_msgs__msg__CompressedImage * ros_message = _ros_message;
  {  // timestamp
...
PyObject * foxglove_msgs__msg__compressed_image__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._compressed_image");
