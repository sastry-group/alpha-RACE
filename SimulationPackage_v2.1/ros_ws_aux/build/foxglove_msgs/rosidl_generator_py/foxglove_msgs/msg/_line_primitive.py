...
class Metaclass_LinePrimitive(type):
    """Metaclass of message 'LinePrimitive'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__line_primitive
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__line_primitive
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__line_primitive
            cls._TYPE_SUPPORT = module.type_support_msg__msg__line_primitive
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__line_primitive
    ...
    def LINE_STRIP(self):
        ...
        return Metaclass_LinePrimitive.__constants['LINE_STRIP']

    @property
    def LINE_LOOP(self):
        """Message constant 'LINE_LOOP'."""
        return Metaclass_LinePrimitive.__constants['LINE_LOOP']

    @property
    def LINE_LIST(self):
        """Message constant 'LINE_LIST'."""
        return Metaclass_LinePrimitive.__constants['LINE_LIST']


class LinePrimitive(metaclass=Metaclass_LinePrimitive):
    """
    Message class 'LinePrimitive'.
