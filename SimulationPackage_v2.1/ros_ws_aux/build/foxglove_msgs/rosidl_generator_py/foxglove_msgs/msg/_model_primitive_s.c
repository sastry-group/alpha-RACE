...
bool foxglove_msgs__msg__model_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._model_primitive.ModelPrimitive", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__ModelPrimitive * ros_message = _ros_message;
  {  // pose
  ...
  {  // override_color
    PyObject * field = PyObject_GetAttrString(_pymsg, "override_color");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->override_color = (Py_True == field);
    Py_DECREF(field);
  }
  {  // url
  ...
  {  // media_type
    PyObject * field = PyObject_GetAttrString(_pymsg, "media_type");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->media_type, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of ModelPrimitive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._model_primitive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ModelPrimitive");
  ...
  {  // override_color
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->override_color ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "override_color", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // media_type
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->media_type.data,
      strlen(ros_message->media_type.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "media_type", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
