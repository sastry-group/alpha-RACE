...
bool foxglove_msgs__msg__cone_attributes__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool foxglove_msgs__msg__cone_list_marker__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._cone_list_marker.ConeListMarker", full_classname_dest, 50) == 0);
  }
  foxglove_msgs__msg__ConeListMarker * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // attributes
    ...
    if (!foxglove_msgs__msg__ConeAttributes__Sequence__init(&(ros_message->attributes), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create foxglove_msgs__msg__ConeAttributes__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    foxglove_msgs__msg__ConeAttributes * dest = ros_message->attributes.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!foxglove_msgs__msg__cone_attributes__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of ConeListMarker */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._cone_list_marker");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeListMarker");
  ...
  {  // attributes
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = foxglove_msgs__msg__cone_attributes__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
