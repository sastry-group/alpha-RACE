...
class Metaclass_PointCloud(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__point_cloud
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__point_cloud
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__point_cloud
            cls._TYPE_SUPPORT = module.type_support_msg__msg__point_cloud
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__point_cloud
...
class PointCloud(metaclass=Metaclass_PointCloud):
    ...
    def __init__(self, **kwargs):
        ...
        self.point_stride = kwargs.get('point_stride', int())
    ...
    def __eq__(self, other):
        ...
        if self.pose != other.pose:
            return False
        if self.point_stride != other.point_stride:
            return False
    ...
    @builtins.property
    def point_stride(self):
        """Message field 'point_stride'."""
        return self._point_stride

    @point_stride.setter
    def point_stride(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'point_stride' field must be of type 'int'"
            assert value >= 0 and value < 4294967296, \
                "The 'point_stride' field must be an unsigned integer in [0, 4294967295]"
        self._point_stride = value
