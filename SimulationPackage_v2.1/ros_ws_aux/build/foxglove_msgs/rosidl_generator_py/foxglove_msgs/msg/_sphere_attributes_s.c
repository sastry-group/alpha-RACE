...
bool foxglove_msgs__msg__sphere_attributes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._sphere_attributes.SphereAttributes", full_classname_dest, 53) == 0);
  }
  foxglove_msgs__msg__SphereAttributes * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of SphereAttributes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._sphere_attributes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SphereAttributes");
