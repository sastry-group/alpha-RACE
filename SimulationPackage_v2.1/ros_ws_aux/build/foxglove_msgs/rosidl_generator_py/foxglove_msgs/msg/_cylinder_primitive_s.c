...
bool foxglove_msgs__msg__cylinder_primitive__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._cylinder_primitive.CylinderPrimitive", full_classname_dest, 55) == 0);
  }
  foxglove_msgs__msg__CylinderPrimitive * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of CylinderPrimitive */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._cylinder_primitive");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CylinderPrimitive");
