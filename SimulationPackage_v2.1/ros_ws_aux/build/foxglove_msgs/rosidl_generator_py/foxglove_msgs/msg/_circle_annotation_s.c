...
bool foxglove_msgs__msg__circle_annotation__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._circle_annotation.CircleAnnotation", full_classname_dest, 53) == 0);
  }
  foxglove_msgs__msg__CircleAnnotation * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of CircleAnnotation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._circle_annotation");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CircleAnnotation");
