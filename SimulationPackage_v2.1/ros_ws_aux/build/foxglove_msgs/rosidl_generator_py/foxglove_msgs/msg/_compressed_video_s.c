...
bool foxglove_msgs__msg__compressed_video__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._compressed_video.CompressedVideo", full_classname_dest, 51) == 0);
  }
  foxglove_msgs__msg__CompressedVideo * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of CompressedVideo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._compressed_video");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CompressedVideo");
