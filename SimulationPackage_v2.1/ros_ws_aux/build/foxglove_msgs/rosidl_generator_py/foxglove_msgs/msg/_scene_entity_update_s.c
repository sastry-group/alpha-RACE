...
bool foxglove_msgs__msg__scene_entity_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._scene_entity_update.SceneEntityUpdate", full_classname_dest, 56) == 0);
  }
  foxglove_msgs__msg__SceneEntityUpdate * ros_message = _ros_message;
  {  // deletions
...
{
  /* NOTE(esteve): Call constructor of SceneEntityUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._scene_entity_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SceneEntityUpdate");
