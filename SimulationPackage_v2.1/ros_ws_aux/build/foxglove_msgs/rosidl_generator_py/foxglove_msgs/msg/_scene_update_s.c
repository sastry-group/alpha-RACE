...
bool foxglove_msgs__msg__scene_update__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._scene_update.SceneUpdate", full_classname_dest, 43) == 0);
  }
  foxglove_msgs__msg__SceneUpdate * ros_message = _ros_message;
  {  // deletions
...
{
  /* NOTE(esteve): Call constructor of SceneUpdate */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._scene_update");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SceneUpdate");
