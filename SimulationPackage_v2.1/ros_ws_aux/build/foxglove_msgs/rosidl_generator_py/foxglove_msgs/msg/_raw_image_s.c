...
bool foxglove_msgs__msg__raw_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._raw_image.RawImage", full_classname_dest, 37) == 0);
  }
  foxglove_msgs__msg__RawImage * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of RawImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._raw_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RawImage");
