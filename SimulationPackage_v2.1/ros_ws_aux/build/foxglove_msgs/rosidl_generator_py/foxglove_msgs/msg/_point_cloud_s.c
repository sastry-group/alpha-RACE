...
bool foxglove_msgs__msg__point_cloud__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._point_cloud.PointCloud", full_classname_dest, 41) == 0);
  }
  foxglove_msgs__msg__PointCloud * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // point_stride
    PyObject * field = PyObject_GetAttrString(_pymsg, "point_stride");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->point_stride = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // fields
...
PyObject * foxglove_msgs__msg__point_cloud__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._point_cloud");
  ...
  {  // point_stride
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->point_stride);
    {
      int rc = PyObject_SetAttrString(_pymessage, "point_stride", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
