...
bool foxglove_msgs__msg__cone_attributes__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._cone_attributes.ConeAttributes", full_classname_dest, 49) == 0);
  }
  foxglove_msgs__msg__ConeAttributes * ros_message = _ros_message;
  {  // pose
...
{
  /* NOTE(esteve): Call constructor of ConeAttributes */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._cone_attributes");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ConeAttributes");
