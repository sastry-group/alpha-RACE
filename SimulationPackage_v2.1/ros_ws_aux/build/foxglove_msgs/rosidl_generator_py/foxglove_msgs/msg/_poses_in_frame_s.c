...
bool foxglove_msgs__msg__poses_in_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("foxglove_msgs.msg._poses_in_frame.PosesInFrame", full_classname_dest, 46) == 0);
  }
  foxglove_msgs__msg__PosesInFrame * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of PosesInFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("foxglove_msgs.msg._poses_in_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PosesInFrame");
