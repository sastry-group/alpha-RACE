...
#ifndef FOXGLOVE_MSGS__MSG__DETAIL__CUBE_MARKER__TRAITS_HPP_
#define FOXGLOVE_MSGS__MSG__DETAIL__CUBE_MARKER__TRAITS_HPP_
...
inline std::string to_yaml(const CubeMarker & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const foxglove_msgs::msg::CubeMarker & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const foxglove_msgs::msg::CubeMarker & msg)
{
  return foxglove_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<foxglove_msgs::msg::CubeMarker>()
{
  return "foxglove_msgs::msg::CubeMarker";
}

template<>
inline const char * name<foxglove_msgs::msg::CubeMarker>()
{
  return "foxglove_msgs/msg/CubeMarker";
}

template<>
struct has_fixed_size<foxglove_msgs::msg::CubeMarker>
...
template<>
struct has_bounded_size<foxglove_msgs::msg::CubeMarker>
...
template<>
struct is_message<foxglove_msgs::msg::CubeMarker>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // FOXGLOVE_MSGS__MSG__DETAIL__CUBE_MARKER__TRAITS_HPP_
