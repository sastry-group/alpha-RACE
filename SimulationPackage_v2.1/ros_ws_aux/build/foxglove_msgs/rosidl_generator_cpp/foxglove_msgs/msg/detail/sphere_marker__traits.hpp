...
#ifndef FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_MARKER__TRAITS_HPP_
#define FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_MARKER__TRAITS_HPP_
...
inline std::string to_yaml(const SphereMarker & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const foxglove_msgs::msg::SphereMarker & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const foxglove_msgs::msg::SphereMarker & msg)
{
  return foxglove_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<foxglove_msgs::msg::SphereMarker>()
{
  return "foxglove_msgs::msg::SphereMarker";
}

template<>
inline const char * name<foxglove_msgs::msg::SphereMarker>()
{
  return "foxglove_msgs/msg/SphereMarker";
}

template<>
struct has_fixed_size<foxglove_msgs::msg::SphereMarker>
...
template<>
struct has_bounded_size<foxglove_msgs::msg::SphereMarker>
...
template<>
struct is_message<foxglove_msgs::msg::SphereMarker>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_MARKER__TRAITS_HPP_
