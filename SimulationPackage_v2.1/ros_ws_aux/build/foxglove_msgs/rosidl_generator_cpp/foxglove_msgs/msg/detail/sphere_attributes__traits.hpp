...
#ifndef FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_ATTRIBUTES__TRAITS_HPP_
#define FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_ATTRIBUTES__TRAITS_HPP_
...
inline std::string to_yaml(const SphereAttributes & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const foxglove_msgs::msg::SphereAttributes & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const foxglove_msgs::msg::SphereAttributes & msg)
{
  return foxglove_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<foxglove_msgs::msg::SphereAttributes>()
{
  return "foxglove_msgs::msg::SphereAttributes";
}

template<>
inline const char * name<foxglove_msgs::msg::SphereAttributes>()
{
  return "foxglove_msgs/msg/SphereAttributes";
}

template<>
struct has_fixed_size<foxglove_msgs::msg::SphereAttributes>
...
template<>
struct has_bounded_size<foxglove_msgs::msg::SphereAttributes>
...
template<>
struct is_message<foxglove_msgs::msg::SphereAttributes>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // FOXGLOVE_MSGS__MSG__DETAIL__SPHERE_ATTRIBUTES__TRAITS_HPP_
