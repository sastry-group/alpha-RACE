...
#ifndef FOXGLOVE_MSGS__MSG__DETAIL__TRIANGLES_MARKER__TRAITS_HPP_
#define FOXGLOVE_MSGS__MSG__DETAIL__TRIANGLES_MARKER__TRAITS_HPP_
...
inline std::string to_yaml(const TrianglesMarker & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const foxglove_msgs::msg::TrianglesMarker & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const foxglove_msgs::msg::TrianglesMarker & msg)
{
  return foxglove_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<foxglove_msgs::msg::TrianglesMarker>()
{
  return "foxglove_msgs::msg::TrianglesMarker";
}

template<>
inline const char * name<foxglove_msgs::msg::TrianglesMarker>()
{
  return "foxglove_msgs/msg/TrianglesMarker";
}

template<>
struct has_fixed_size<foxglove_msgs::msg::TrianglesMarker>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<foxglove_msgs::msg::TrianglesMarker>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<foxglove_msgs::msg::TrianglesMarker>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // FOXGLOVE_MSGS__MSG__DETAIL__TRIANGLES_MARKER__TRAITS_HPP_
