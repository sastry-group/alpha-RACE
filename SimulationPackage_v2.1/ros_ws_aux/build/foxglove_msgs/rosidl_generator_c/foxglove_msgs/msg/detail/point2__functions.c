...
foxglove_msgs__msg__Point2__create()
{
  ...
  foxglove_msgs__msg__Point2 * msg = (foxglove_msgs__msg__Point2 *)allocator.allocate(sizeof(foxglove_msgs__msg__Point2), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(foxglove_msgs__msg__Point2));
  bool success = foxglove_msgs__msg__Point2__init(msg);
  if (!success) {
...
foxglove_msgs__msg__Point2__destroy(foxglove_msgs__msg__Point2 * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    foxglove_msgs__msg__Point2__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
foxglove_msgs__msg__Point2__Sequence__init(foxglove_msgs__msg__Point2__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  foxglove_msgs__msg__Point2 * data = NULL;

  if (size) {
    data = (foxglove_msgs__msg__Point2 *)allocator.zero_allocate(size, sizeof(foxglove_msgs__msg__Point2), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = foxglove_msgs__msg__Point2__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        foxglove_msgs__msg__Point2__fini(&data[i - 1]);
      }
...
foxglove_msgs__msg__Point2__Sequence__fini(foxglove_msgs__msg__Point2__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      foxglove_msgs__msg__Point2__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  foxglove_msgs__msg__Point2__Sequence * array = (foxglove_msgs__msg__Point2__Sequence *)allocator.allocate(sizeof(foxglove_msgs__msg__Point2__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = foxglove_msgs__msg__Point2__Sequence__init(array, size);
  if (!success) {
...
foxglove_msgs__msg__Point2__Sequence__destroy(foxglove_msgs__msg__Point2__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    foxglove_msgs__msg__Point2__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
foxglove_msgs__msg__Point2__Sequence__are_equal(const foxglove_msgs__msg__Point2__Sequence * lhs, const foxglove_msgs__msg__Point2__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!foxglove_msgs__msg__Point2__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  foxglove_msgs__msg__Point2__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(foxglove_msgs__msg__Point2);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    foxglove_msgs__msg__Point2 * data =
      (foxglove_msgs__msg__Point2 *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!foxglove_msgs__msg__Point2__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          foxglove_msgs__msg__Point2__fini(&output->data[i]);
        }
        return false;
      }
    }
