...
foxglove_msgs__msg__SceneEntities__create()
{
  ...
  foxglove_msgs__msg__SceneEntities * msg = (foxglove_msgs__msg__SceneEntities *)allocator.allocate(sizeof(foxglove_msgs__msg__SceneEntities), allocator.state);
  if (!msg) {
    return NULL;
  }
...
foxglove_msgs__msg__SceneEntities__Sequence__init(foxglove_msgs__msg__SceneEntities__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (foxglove_msgs__msg__SceneEntities *)allocator.zero_allocate(size, sizeof(foxglove_msgs__msg__SceneEntities), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  foxglove_msgs__msg__SceneEntities__Sequence * array = (foxglove_msgs__msg__SceneEntities__Sequence *)allocator.allocate(sizeof(foxglove_msgs__msg__SceneEntities__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  foxglove_msgs__msg__SceneEntities__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    foxglove_msgs__msg__SceneEntities * data =
      (foxglove_msgs__msg__SceneEntities *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!foxglove_msgs__msg__SceneEntities__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          foxglove_msgs__msg__SceneEntities__fini(&output->data[i]);
        }
        return false;
      }
    }
