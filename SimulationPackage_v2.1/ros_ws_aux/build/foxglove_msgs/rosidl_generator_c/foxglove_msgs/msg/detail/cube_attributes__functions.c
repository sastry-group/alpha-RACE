...
foxglove_msgs__msg__CubeAttributes__create()
{
  ...
  foxglove_msgs__msg__CubeAttributes * msg = (foxglove_msgs__msg__CubeAttributes *)allocator.allocate(sizeof(foxglove_msgs__msg__CubeAttributes), allocator.state);
  if (!msg) {
    return NULL;
  }
...
foxglove_msgs__msg__CubeAttributes__Sequence__init(foxglove_msgs__msg__CubeAttributes__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (foxglove_msgs__msg__CubeAttributes *)allocator.zero_allocate(size, sizeof(foxglove_msgs__msg__CubeAttributes), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  foxglove_msgs__msg__CubeAttributes__Sequence * array = (foxglove_msgs__msg__CubeAttributes__Sequence *)allocator.allocate(sizeof(foxglove_msgs__msg__CubeAttributes__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
foxglove_msgs__msg__CubeAttributes__Sequence__are_equal(const foxglove_msgs__msg__CubeAttributes__Sequence * lhs, const foxglove_msgs__msg__CubeAttributes__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!foxglove_msgs__msg__CubeAttributes__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  foxglove_msgs__msg__CubeAttributes__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(foxglove_msgs__msg__CubeAttributes);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    foxglove_msgs__msg__CubeAttributes * data =
      (foxglove_msgs__msg__CubeAttributes *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!foxglove_msgs__msg__CubeAttributes__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          foxglove_msgs__msg__CubeAttributes__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!foxglove_msgs__msg__CubeAttributes__copy(
