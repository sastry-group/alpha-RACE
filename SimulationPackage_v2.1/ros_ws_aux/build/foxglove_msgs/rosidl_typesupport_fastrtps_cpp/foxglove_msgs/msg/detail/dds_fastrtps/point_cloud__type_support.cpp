...
#include "foxglove_msgs/msg/detail/point_cloud__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::PointCloud & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::PointCloud & ros_message)
{
  // Member: timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::PointCloud;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::PointCloud *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::PointCloud *>(
    untyped_ros_message);
...
static size_t _PointCloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PointCloud(full_bounded, is_plain, 0);
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_PointCloud__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, PointCloud)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_PointCloud__handle;
}
