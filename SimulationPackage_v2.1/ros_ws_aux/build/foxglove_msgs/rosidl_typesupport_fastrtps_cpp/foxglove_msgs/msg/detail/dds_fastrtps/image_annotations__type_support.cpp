...
#include "foxglove_msgs/msg/detail/image_annotations__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const foxglove_msgs::msg::CircleAnnotation &,
...
{
bool cdr_serialize(
  const foxglove_msgs::msg::PointsAnnotation &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
{
bool cdr_serialize(
  const foxglove_msgs::msg::TextAnnotation &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const foxglove_msgs::msg::ImageAnnotations & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::ImageAnnotations & ros_message)
{
  // Member: circles
  {
    uint32_t cdrSize;
  ...
  // Member: texts
  {
    ...
    cdr >> cdrSize;
    size_t size = static_cast<size_t>(cdrSize);
    ros_message.texts.resize(size);
    for (size_t i = 0; i < size; i++) {
      foxglove_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.texts[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: texts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        foxglove_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
        ros_message.texts[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_foxglove_msgs
max_serialized_size_ImageAnnotations(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: circles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        foxglove_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_CircleAnnotation(
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        foxglove_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_PointsAnnotation(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: texts
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        foxglove_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TextAnnotation(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::ImageAnnotations;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::ImageAnnotations *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::ImageAnnotations *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ImageAnnotations__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::ImageAnnotations *>(
...
static size_t _ImageAnnotations__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ImageAnnotations(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ImageAnnotations__callbacks = {
  "foxglove_msgs::msg",
  "ImageAnnotations",
...
static rosidl_message_type_support_t _ImageAnnotations__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ImageAnnotations__callbacks,
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_ImageAnnotations__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, ImageAnnotations)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_ImageAnnotations__handle;
}
