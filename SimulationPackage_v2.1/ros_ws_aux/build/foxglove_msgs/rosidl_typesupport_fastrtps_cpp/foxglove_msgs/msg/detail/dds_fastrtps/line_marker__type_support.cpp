...
#include "foxglove_msgs/msg/detail/line_marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::LineMarker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::LineMarker & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_foxglove_msgs
max_serialized_size_LineMarker(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::LineMarker;
    is_plain =
      (
...
static bool _LineMarker__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::LineMarker *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}

static bool _LineMarker__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::LineMarker *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LineMarker__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::LineMarker *>(
...
static size_t _LineMarker__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_LineMarker(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LineMarker__callbacks = {
  "foxglove_msgs::msg",
  "LineMarker",
  _LineMarker__cdr_serialize,
  _LineMarker__cdr_deserialize,
  _LineMarker__get_serialized_size,
  _LineMarker__max_serialized_size
};

static rosidl_message_type_support_t _LineMarker__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LineMarker__callbacks,
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_LineMarker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, LineMarker)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_LineMarker__handle;
}
