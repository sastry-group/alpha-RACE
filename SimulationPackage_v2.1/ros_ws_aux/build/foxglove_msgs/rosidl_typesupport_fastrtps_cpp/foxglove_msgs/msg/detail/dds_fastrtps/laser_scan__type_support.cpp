...
#include "foxglove_msgs/msg/detail/laser_scan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::LaserScan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::LaserScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::LaserScan *>(
    untyped_ros_message);
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_LaserScan__handle;
}
