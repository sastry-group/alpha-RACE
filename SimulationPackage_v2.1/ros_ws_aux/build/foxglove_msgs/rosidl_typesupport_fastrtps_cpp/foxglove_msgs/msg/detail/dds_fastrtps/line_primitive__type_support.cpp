...
#include "foxglove_msgs/msg/detail/line_primitive__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::LinePrimitive & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::LinePrimitive & ros_message)
{
  // Member: type
  cdr >> ros_message.type;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_foxglove_msgs
max_serialized_size_LinePrimitive(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::LinePrimitive;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::LinePrimitive *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::LinePrimitive *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LinePrimitive__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::LinePrimitive *>(
...
static size_t _LinePrimitive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LinePrimitive(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LinePrimitive__callbacks = {
  "foxglove_msgs::msg",
  "LinePrimitive",
...
static rosidl_message_type_support_t _LinePrimitive__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LinePrimitive__callbacks,
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_LinePrimitive__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, LinePrimitive)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_LinePrimitive__handle;
}
