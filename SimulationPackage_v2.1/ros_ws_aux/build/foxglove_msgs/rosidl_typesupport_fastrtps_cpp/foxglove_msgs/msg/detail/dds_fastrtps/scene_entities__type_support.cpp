...
#include "foxglove_msgs/msg/detail/scene_entities__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::SceneEntities & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::SceneEntities & ros_message)
{
  // Member: deletions
  {
    uint32_t cdrSize;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_foxglove_msgs
max_serialized_size_SceneEntities(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::SceneEntities;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::SceneEntities *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::SceneEntities *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SceneEntities__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::SceneEntities *>(
...
static size_t _SceneEntities__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SceneEntities(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SceneEntities__callbacks = {
  "foxglove_msgs::msg",
  "SceneEntities",
...
static rosidl_message_type_support_t _SceneEntities__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SceneEntities__callbacks,
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_SceneEntities__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, SceneEntities)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_SceneEntities__handle;
}
