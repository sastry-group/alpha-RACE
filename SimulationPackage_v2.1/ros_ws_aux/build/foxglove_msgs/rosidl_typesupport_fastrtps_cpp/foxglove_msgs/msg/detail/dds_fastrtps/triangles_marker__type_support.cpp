...
#include "foxglove_msgs/msg/detail/triangles_marker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::TrianglesMarker & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::TrianglesMarker & ros_message)
{
  // Member: timestamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_foxglove_msgs
max_serialized_size_TrianglesMarker(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::TrianglesMarker;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::TrianglesMarker *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::TrianglesMarker *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TrianglesMarker__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::TrianglesMarker *>(
...
static size_t _TrianglesMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TrianglesMarker(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TrianglesMarker__callbacks = {
  "foxglove_msgs::msg",
  "TrianglesMarker",
...
static rosidl_message_type_support_t _TrianglesMarker__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TrianglesMarker__callbacks,
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_TrianglesMarker__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, TrianglesMarker)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_TrianglesMarker__handle;
}
