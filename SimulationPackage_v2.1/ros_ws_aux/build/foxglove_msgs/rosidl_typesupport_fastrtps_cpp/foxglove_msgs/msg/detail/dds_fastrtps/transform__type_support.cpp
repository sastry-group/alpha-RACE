...
#include "foxglove_msgs/msg/detail/transform__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const foxglove_msgs::msg::Transform & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  foxglove_msgs::msg::Transform & ros_message)
{
  // Member: timestamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs::msg::Transform;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const foxglove_msgs::msg::Transform *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<foxglove_msgs::msg::Transform *>(
    untyped_ros_message);
...
{
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_Transform__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, foxglove_msgs, msg, Transform)() {
  return &foxglove_msgs::msg::typesupport_fastrtps_cpp::_Transform__handle;
}
