...
#include "foxglove_msgs/msg/detail/model_marker__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // mime_type, url
#include "rosidl_runtime_c/string_functions.h"  // mime_type, url
...
using _ModelMarker__ros_msg_type = foxglove_msgs__msg__ModelMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ModelMarker__ros_msg_type * ros_message = static_cast<const _ModelMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  // Field name: use_embedded_materials
  {
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->mime_type;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  _ModelMarker__ros_msg_type * ros_message = static_cast<_ModelMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: mime_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->mime_type.data) {
      rosidl_runtime_c__String__init(&ros_message->mime_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->mime_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'mime_type'\n");
      return false;
    }
  }
...
static uint32_t _ModelMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__ModelMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__ModelMarker;
    is_plain =
      (
...
static size_t _ModelMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__ModelMarker(
...
static message_type_support_callbacks_t __callbacks_ModelMarker = {
  "foxglove_msgs::msg",
  "ModelMarker",
