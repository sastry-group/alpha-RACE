...
#include "foxglove_msgs/msg/detail/cylinder_primitive__rosidl_typesupport_fastrtps_c.h"
...
using _CylinderPrimitive__ros_msg_type = foxglove_msgs__msg__CylinderPrimitive;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CylinderPrimitive__ros_msg_type * ros_message = static_cast<const _CylinderPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CylinderPrimitive__ros_msg_type * ros_message = static_cast<_CylinderPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_foxglove_msgs__msg__CylinderPrimitive(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CylinderPrimitive__ros_msg_type * ros_message = static_cast<const _CylinderPrimitive__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _CylinderPrimitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__CylinderPrimitive(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__CylinderPrimitive(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__CylinderPrimitive;
    is_plain =
      (
...
static size_t _CylinderPrimitive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__CylinderPrimitive(
...
static message_type_support_callbacks_t __callbacks_CylinderPrimitive = {
  "foxglove_msgs::msg",
  "CylinderPrimitive",
...
static rosidl_message_type_support_t _CylinderPrimitive__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CylinderPrimitive,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, CylinderPrimitive)() {
  return &_CylinderPrimitive__type_support;
}
