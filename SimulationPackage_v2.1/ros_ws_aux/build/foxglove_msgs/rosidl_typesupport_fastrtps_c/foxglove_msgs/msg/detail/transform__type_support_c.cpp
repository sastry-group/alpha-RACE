...
#include "foxglove_msgs/msg/detail/transform__rosidl_typesupport_fastrtps_c.h"
...
using _Transform__ros_msg_type = foxglove_msgs__msg__Transform;
...
size_t get_serialized_size_foxglove_msgs__msg__Transform(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Transform__ros_msg_type * ros_message = static_cast<const _Transform__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Transform__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__Transform(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__Transform(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__Transform;
    is_plain =
      (
...
static size_t _Transform__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__Transform(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, Transform)() {
