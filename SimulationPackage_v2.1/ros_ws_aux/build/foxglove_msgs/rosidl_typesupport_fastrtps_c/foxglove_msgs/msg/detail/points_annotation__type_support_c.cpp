...
#include "foxglove_msgs/msg/detail/points_annotation__rosidl_typesupport_fastrtps_c.h"
...
#include "foxglove_msgs/msg/detail/color__functions.h"  // fill_color, outline_color, outline_colors
#include "foxglove_msgs/msg/detail/point2__functions.h"  // points
...
using _PointsAnnotation__ros_msg_type = foxglove_msgs__msg__PointsAnnotation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _PointsAnnotation__ros_msg_type * ros_message = static_cast<const _PointsAnnotation__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _PointsAnnotation__ros_msg_type * ros_message = static_cast<_PointsAnnotation__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      foxglove_msgs__msg__Point2__Sequence__fini(&ros_message->points);
    }
  ...
  // Field name: outline_colors
  {
    ...
    if (ros_message->outline_colors.data) {
      foxglove_msgs__msg__Color__Sequence__fini(&ros_message->outline_colors);
    }
...
static uint32_t _PointsAnnotation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__PointsAnnotation(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__PointsAnnotation;
    is_plain =
      (
...
static size_t _PointsAnnotation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__PointsAnnotation(
...
static message_type_support_callbacks_t __callbacks_PointsAnnotation = {
  "foxglove_msgs::msg",
  "PointsAnnotation",
...
static rosidl_message_type_support_t _PointsAnnotation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_PointsAnnotation,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, PointsAnnotation)() {
  return &_PointsAnnotation__type_support;
}
