...
#include "foxglove_msgs/msg/detail/triangle_list_marker__rosidl_typesupport_fastrtps_c.h"
...
using _TriangleListMarker__ros_msg_type = foxglove_msgs__msg__TriangleListMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TriangleListMarker__ros_msg_type * ros_message = static_cast<const _TriangleListMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TriangleListMarker__ros_msg_type * ros_message = static_cast<_TriangleListMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TriangleListMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__TriangleListMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__TriangleListMarker;
    is_plain =
      (
...
static size_t _TriangleListMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__TriangleListMarker(
...
static message_type_support_callbacks_t __callbacks_TriangleListMarker = {
  "foxglove_msgs::msg",
  "TriangleListMarker",
...
static rosidl_message_type_support_t _TriangleListMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TriangleListMarker,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, TriangleListMarker)() {
  return &_TriangleListMarker__type_support;
}
