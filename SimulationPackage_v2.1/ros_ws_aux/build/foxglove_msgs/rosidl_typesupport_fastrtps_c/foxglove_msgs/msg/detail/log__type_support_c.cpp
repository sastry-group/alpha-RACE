...
#include "foxglove_msgs/msg/detail/log__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // file, message, name
#include "rosidl_runtime_c/string_functions.h"  // file, message, name
...
using _Log__ros_msg_type = foxglove_msgs__msg__Log;
...
size_t get_serialized_size_foxglove_msgs__msg__Log(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Log__ros_msg_type * ros_message = static_cast<const _Log__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Log__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__Log(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__Log(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__Log;
    is_plain =
      (
...
static size_t _Log__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__Log(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, Log)() {
