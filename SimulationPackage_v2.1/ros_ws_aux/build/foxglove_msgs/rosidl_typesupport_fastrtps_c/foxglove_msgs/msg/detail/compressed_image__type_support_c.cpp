...
#include "foxglove_msgs/msg/detail/compressed_image__rosidl_typesupport_fastrtps_c.h"
...
using _CompressedImage__ros_msg_type = foxglove_msgs__msg__CompressedImage;
...
static uint32_t _CompressedImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__CompressedImage(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__CompressedImage;
    is_plain =
      (
...
static size_t _CompressedImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__CompressedImage(
