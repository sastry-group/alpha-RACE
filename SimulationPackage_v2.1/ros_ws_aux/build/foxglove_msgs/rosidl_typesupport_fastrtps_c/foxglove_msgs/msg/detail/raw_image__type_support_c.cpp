...
#include "foxglove_msgs/msg/detail/raw_image__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // encoding, frame_id
#include "rosidl_runtime_c/string_functions.h"  // encoding, frame_id
...
using _RawImage__ros_msg_type = foxglove_msgs__msg__RawImage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _RawImage__ros_msg_type * ros_message = static_cast<const _RawImage__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _RawImage__ros_msg_type * ros_message = static_cast<_RawImage__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_foxglove_msgs__msg__RawImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RawImage__ros_msg_type * ros_message = static_cast<const _RawImage__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RawImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__RawImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__RawImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__RawImage;
    is_plain =
      (
...
static size_t _RawImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__RawImage(
...
static message_type_support_callbacks_t __callbacks_RawImage = {
  "foxglove_msgs::msg",
  "RawImage",
...
static rosidl_message_type_support_t _RawImage__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_RawImage,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, RawImage)() {
  return &_RawImage__type_support;
}
