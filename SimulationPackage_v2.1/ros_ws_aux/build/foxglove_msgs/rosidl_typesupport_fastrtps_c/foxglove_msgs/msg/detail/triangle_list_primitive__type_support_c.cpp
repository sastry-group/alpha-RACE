...
#include "foxglove_msgs/msg/detail/triangle_list_primitive__rosidl_typesupport_fastrtps_c.h"
...
using _TriangleListPrimitive__ros_msg_type = foxglove_msgs__msg__TriangleListPrimitive;

static bool _TriangleListPrimitive__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TriangleListPrimitive__ros_msg_type * ros_message = static_cast<const _TriangleListPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
...
static bool _TriangleListPrimitive__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TriangleListPrimitive__ros_msg_type * ros_message = static_cast<_TriangleListPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_foxglove_msgs__msg__TriangleListPrimitive(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TriangleListPrimitive__ros_msg_type * ros_message = static_cast<const _TriangleListPrimitive__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TriangleListPrimitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__TriangleListPrimitive(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__TriangleListPrimitive(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__TriangleListPrimitive;
    is_plain =
      (
...
static size_t _TriangleListPrimitive__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_foxglove_msgs__msg__TriangleListPrimitive(
...
static message_type_support_callbacks_t __callbacks_TriangleListPrimitive = {
  "foxglove_msgs::msg",
  "TriangleListPrimitive",
  _TriangleListPrimitive__cdr_serialize,
  _TriangleListPrimitive__cdr_deserialize,
  _TriangleListPrimitive__get_serialized_size,
  _TriangleListPrimitive__max_serialized_size
};

static rosidl_message_type_support_t _TriangleListPrimitive__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TriangleListPrimitive,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, TriangleListPrimitive)() {
  return &_TriangleListPrimitive__type_support;
}
