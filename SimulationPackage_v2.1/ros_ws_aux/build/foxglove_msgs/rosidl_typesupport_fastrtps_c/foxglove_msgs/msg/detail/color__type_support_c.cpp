...
#include "foxglove_msgs/msg/detail/color__rosidl_typesupport_fastrtps_c.h"
...
using _Color__ros_msg_type = foxglove_msgs__msg__Color;
...
static uint32_t _Color__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__Color(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__Color;
    is_plain =
      (
      offsetof(DataType, a) +
      last_member_size
...
static size_t _Color__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__Color(
