...
#include "foxglove_msgs/msg/detail/model_primitive__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // media_type, url
#include "rosidl_runtime_c/string_functions.h"  // media_type, url
...
using _ModelPrimitive__ros_msg_type = foxglove_msgs__msg__ModelPrimitive;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ModelPrimitive__ros_msg_type * ros_message = static_cast<const _ModelPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  {
    const rosidl_runtime_c__String * str = &ros_message->media_type;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  _ModelPrimitive__ros_msg_type * ros_message = static_cast<_ModelPrimitive__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: media_type
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->media_type.data) {
      rosidl_runtime_c__String__init(&ros_message->media_type);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->media_type,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'media_type'\n");
      return false;
    }
  }
...
size_t get_serialized_size_foxglove_msgs__msg__ModelPrimitive(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ModelPrimitive__ros_msg_type * ros_message = static_cast<const _ModelPrimitive__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ModelPrimitive__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__ModelPrimitive(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__ModelPrimitive(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__ModelPrimitive;
    is_plain =
      (
...
static size_t _ModelPrimitive__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__ModelPrimitive(
...
static message_type_support_callbacks_t __callbacks_ModelPrimitive = {
  "foxglove_msgs::msg",
  "ModelPrimitive",
...
static rosidl_message_type_support_t _ModelPrimitive__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ModelPrimitive,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, ModelPrimitive)() {
  return &_ModelPrimitive__type_support;
}
