...
#include "foxglove_msgs/msg/detail/cone_list_marker__rosidl_typesupport_fastrtps_c.h"
...
#include "foxglove_msgs/msg/detail/cone_attributes__functions.h"  // attributes
...
size_t get_serialized_size_foxglove_msgs__msg__ConeAttributes(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_foxglove_msgs__msg__ConeAttributes(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, ConeAttributes)();
...
using _ConeListMarker__ros_msg_type = foxglove_msgs__msg__ConeListMarker;

static bool _ConeListMarker__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ConeListMarker__ros_msg_type * ros_message = static_cast<const _ConeListMarker__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: attributes
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, ConeAttributes
      )()->data);
...
static bool _ConeListMarker__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _ConeListMarker__ros_msg_type * ros_message = static_cast<_ConeListMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: attributes
  {
    ...
    if (ros_message->attributes.data) {
      foxglove_msgs__msg__ConeAttributes__Sequence__fini(&ros_message->attributes);
    }
    if (!foxglove_msgs__msg__ConeAttributes__Sequence__init(&ros_message->attributes, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name attributes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_foxglove_msgs__msg__ConeAttributes(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _ConeListMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__ConeListMarker(
  ...
  size_t current_alignment)
{
  ...
  // member: attributes
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_foxglove_msgs__msg__ConeAttributes(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__ConeListMarker;
    is_plain =
      (
...
static size_t _ConeListMarker__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_foxglove_msgs__msg__ConeListMarker(
...
static message_type_support_callbacks_t __callbacks_ConeListMarker = {
  "foxglove_msgs::msg",
  "ConeListMarker",
  _ConeListMarker__cdr_serialize,
  _ConeListMarker__cdr_deserialize,
  _ConeListMarker__get_serialized_size,
  _ConeListMarker__max_serialized_size
};

static rosidl_message_type_support_t _ConeListMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ConeListMarker,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, ConeListMarker)() {
  return &_ConeListMarker__type_support;
}
