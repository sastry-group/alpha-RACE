...
#include "foxglove_msgs/msg/detail/text_marker__rosidl_typesupport_fastrtps_c.h"
...
using _TextMarker__ros_msg_type = foxglove_msgs__msg__TextMarker;

static bool _TextMarker__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TextMarker__ros_msg_type * ros_message = static_cast<const _TextMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
...
static bool _TextMarker__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _TextMarker__ros_msg_type * ros_message = static_cast<_TextMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _TextMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__TextMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__TextMarker;
    is_plain =
      (
...
static size_t _TextMarker__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_foxglove_msgs__msg__TextMarker(
...
static message_type_support_callbacks_t __callbacks_TextMarker = {
  "foxglove_msgs::msg",
  "TextMarker",
  _TextMarker__cdr_serialize,
  _TextMarker__cdr_deserialize,
  _TextMarker__get_serialized_size,
  _TextMarker__max_serialized_size
};

static rosidl_message_type_support_t _TextMarker__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TextMarker,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, TextMarker)() {
  return &_TextMarker__type_support;
}
