...
#include "foxglove_msgs/msg/detail/point_cloud__rosidl_typesupport_fastrtps_c.h"
...
#include "foxglove_msgs/msg/detail/packed_element_field__functions.h"  // fields
...
using _PointCloud__ros_msg_type = foxglove_msgs__msg__PointCloud;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: point_stride
  {
    cdr << ros_message->point_stride;
  }
  ...
  // Field name: fields
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, PackedElementField
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: fields
  {
    ...
    if (ros_message->fields.data) {
      foxglove_msgs__msg__PackedElementField__Sequence__fini(&ros_message->fields);
    }
...
size_t get_serialized_size_foxglove_msgs__msg__PointCloud(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PointCloud__ros_msg_type * ros_message = static_cast<const _PointCloud__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name point_stride
  {
    size_t item_size = sizeof(ros_message->point_stride);
  ...
  // field.name fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_foxglove_msgs__msg__PackedElementField(
...
static uint32_t _PointCloud__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__PointCloud(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__PointCloud(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: fields
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_foxglove_msgs__msg__PackedElementField(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__PointCloud;
    is_plain =
      (
...
static size_t _PointCloud__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__PointCloud(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, PointCloud)() {
