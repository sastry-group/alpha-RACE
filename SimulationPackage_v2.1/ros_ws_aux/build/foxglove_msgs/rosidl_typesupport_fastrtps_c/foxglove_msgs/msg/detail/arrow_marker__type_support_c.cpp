...
#include "foxglove_msgs/msg/detail/arrow_marker__rosidl_typesupport_fastrtps_c.h"
...
using _ArrowMarker__ros_msg_type = foxglove_msgs__msg__ArrowMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ArrowMarker__ros_msg_type * ros_message = static_cast<const _ArrowMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ArrowMarker__ros_msg_type * ros_message = static_cast<_ArrowMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: pose
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _ArrowMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__ArrowMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__ArrowMarker;
    is_plain =
      (
...
static size_t _ArrowMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__ArrowMarker(
...
static message_type_support_callbacks_t __callbacks_ArrowMarker = {
  "foxglove_msgs::msg",
  "ArrowMarker",
