...
#include "foxglove_msgs/msg/detail/line_marker__rosidl_typesupport_fastrtps_c.h"
...
using _LineMarker__ros_msg_type = foxglove_msgs__msg__LineMarker;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LineMarker__ros_msg_type * ros_message = static_cast<const _LineMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LineMarker__ros_msg_type * ros_message = static_cast<_LineMarker__ros_msg_type *>(untyped_ros_message);
  // Field name: type
  {
    cdr >> ros_message->type;
  }
...
static uint32_t _LineMarker__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__LineMarker(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__LineMarker;
    is_plain =
      (
...
static size_t _LineMarker__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__LineMarker(
...
static message_type_support_callbacks_t __callbacks_LineMarker = {
  "foxglove_msgs::msg",
  "LineMarker",
