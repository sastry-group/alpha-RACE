...
#include "foxglove_msgs/msg/detail/point2__rosidl_typesupport_fastrtps_c.h"
...
using _Point2__ros_msg_type = foxglove_msgs__msg__Point2;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Point2__ros_msg_type * ros_message = static_cast<const _Point2__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr << ros_message->x;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Point2__ros_msg_type * ros_message = static_cast<_Point2__ros_msg_type *>(untyped_ros_message);
  // Field name: x
  {
    cdr >> ros_message->x;
  }
...
static uint32_t _Point2__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__Point2(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__Point2;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _Point2__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__Point2(
...
static message_type_support_callbacks_t __callbacks_Point2 = {
  "foxglove_msgs::msg",
  "Point2",
...
static rosidl_message_type_support_t _Point2__type_support = {
