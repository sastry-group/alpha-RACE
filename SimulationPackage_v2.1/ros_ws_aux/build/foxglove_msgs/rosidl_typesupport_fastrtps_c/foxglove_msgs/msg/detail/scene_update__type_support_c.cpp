...
#include "foxglove_msgs/msg/detail/scene_update__rosidl_typesupport_fastrtps_c.h"
...
using _SceneUpdate__ros_msg_type = foxglove_msgs__msg__SceneUpdate;

static bool _SceneUpdate__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SceneUpdate__ros_msg_type * ros_message = static_cast<const _SceneUpdate__ros_msg_type *>(untyped_ros_message);
...
static bool _SceneUpdate__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _SceneUpdate__ros_msg_type * ros_message = static_cast<_SceneUpdate__ros_msg_type *>(untyped_ros_message);
  // Field name: deletions
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_foxglove_msgs__msg__SceneUpdate(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SceneUpdate__ros_msg_type * ros_message = static_cast<const _SceneUpdate__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SceneUpdate__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__SceneUpdate(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__SceneUpdate(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__SceneUpdate;
    is_plain =
      (
...
static size_t _SceneUpdate__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_foxglove_msgs__msg__SceneUpdate(
...
static message_type_support_callbacks_t __callbacks_SceneUpdate = {
  "foxglove_msgs::msg",
  "SceneUpdate",
  _SceneUpdate__cdr_serialize,
  _SceneUpdate__cdr_deserialize,
  _SceneUpdate__get_serialized_size,
  _SceneUpdate__max_serialized_size
};

static rosidl_message_type_support_t _SceneUpdate__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SceneUpdate,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, SceneUpdate)() {
  return &_SceneUpdate__type_support;
}
