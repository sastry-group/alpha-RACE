...
#include "foxglove_msgs/msg/detail/circle_annotation__rosidl_typesupport_fastrtps_c.h"
...
#include "foxglove_msgs/msg/detail/color__functions.h"  // fill_color, outline_color
...
using _CircleAnnotation__ros_msg_type = foxglove_msgs__msg__CircleAnnotation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CircleAnnotation__ros_msg_type * ros_message = static_cast<const _CircleAnnotation__ros_msg_type *>(untyped_ros_message);
  ...
  void * untyped_ros_message)
{
  ...
  _CircleAnnotation__ros_msg_type * ros_message = static_cast<_CircleAnnotation__ros_msg_type *>(untyped_ros_message);
  // Field name: timestamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _CircleAnnotation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__CircleAnnotation(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__CircleAnnotation;
    is_plain =
      (
...
static size_t _CircleAnnotation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__CircleAnnotation(
...
static message_type_support_callbacks_t __callbacks_CircleAnnotation = {
  "foxglove_msgs::msg",
  "CircleAnnotation",
...
static rosidl_message_type_support_t _CircleAnnotation__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CircleAnnotation,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, CircleAnnotation)() {
  return &_CircleAnnotation__type_support;
}
