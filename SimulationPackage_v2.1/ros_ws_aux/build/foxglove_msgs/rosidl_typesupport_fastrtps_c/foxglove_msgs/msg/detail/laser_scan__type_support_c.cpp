...
#include "foxglove_msgs/msg/detail/laser_scan__rosidl_typesupport_fastrtps_c.h"
...
using _LaserScan__ros_msg_type = foxglove_msgs__msg__LaserScan;
...
size_t get_serialized_size_foxglove_msgs__msg__LaserScan(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaserScan__ros_msg_type * ros_message = static_cast<const _LaserScan__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LaserScan__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_foxglove_msgs__msg__LaserScan(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_foxglove_msgs
size_t max_serialized_size_foxglove_msgs__msg__LaserScan(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = foxglove_msgs__msg__LaserScan;
    is_plain =
      (
...
static size_t _LaserScan__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_foxglove_msgs__msg__LaserScan(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, foxglove_msgs, msg, LaserScan)() {
