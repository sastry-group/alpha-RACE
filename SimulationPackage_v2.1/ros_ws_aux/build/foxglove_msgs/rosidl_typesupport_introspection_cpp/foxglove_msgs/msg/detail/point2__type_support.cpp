...
{
  new (message_memory) foxglove_msgs::msg::Point2(_init);
}

void Point2_fini_function(void * message_memory)
{
  auto typed_message = static_cast<foxglove_msgs::msg::Point2 *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Point2_message_member_array[2] = {
  {
    ...
    offsetof(foxglove_msgs::msg::Point2, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::Point2, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Point2_message_members = {
  ...
  "Point2",  // message name
  2,  // number of fields
  sizeof(foxglove_msgs::msg::Point2),
...
{
  return &::foxglove_msgs::msg::rosidl_typesupport_introspection_cpp::Point2_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, foxglove_msgs, msg, Point2)() {
  return &::foxglove_msgs::msg::rosidl_typesupport_introspection_cpp::Point2_message_type_support_handle;
}
