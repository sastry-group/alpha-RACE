...
{
  new (message_memory) foxglove_msgs::msg::PointCloud(_init);
}

void PointCloud_fini_function(void * message_memory)
{
  auto typed_message = static_cast<foxglove_msgs::msg::PointCloud *>(message_memory);
  typed_message->~PointCloud();
}

size_t size_function__PointCloud__fields(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<foxglove_msgs::msg::PackedElementField> *>(untyped_member);
  return member->size();
}

const void * get_const_function__PointCloud__fields(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__PointCloud__fields(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PointCloud_message_member_array[6] = {
  {
    "timestamp",  // name
    ...
    offsetof(foxglove_msgs::msg::PointCloud, timestamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::PointCloud, frame_id),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::PointCloud, pose),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::PointCloud, point_stride),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::PointCloud, fields),  // bytes offset in struct
    nullptr,  // default value
    size_function__PointCloud__fields,  // size() function pointer
    get_const_function__PointCloud__fields,  // get_const(index) function pointer
    get_function__PointCloud__fields,  // get(index) function pointer
    fetch_function__PointCloud__fields,  // fetch(index, &value) function pointer
    assign_function__PointCloud__fields,  // assign(index, value) function pointer
    resize_function__PointCloud__fields  // resize(index) function pointer
  },
  {
    "data",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(foxglove_msgs::msg::PointCloud, data),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PointCloud_message_members = {
  ...
  6,  // number of fields
  sizeof(foxglove_msgs::msg::PointCloud),
...
get_message_type_support_handle<foxglove_msgs::msg::PointCloud>()
{
  return &::foxglove_msgs::msg::rosidl_typesupport_introspection_cpp::PointCloud_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, foxglove_msgs, msg, PointCloud)() {
  return &::foxglove_msgs::msg::rosidl_typesupport_introspection_cpp::PointCloud_message_type_support_handle;
}
