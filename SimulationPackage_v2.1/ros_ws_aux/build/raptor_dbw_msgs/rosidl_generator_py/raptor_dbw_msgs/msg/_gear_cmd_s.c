...
bool raptor_dbw_msgs__msg__gear_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._gear_cmd.GearCmd", full_classname_dest, 37) == 0);
  }
  raptor_dbw_msgs__msg__GearCmd * ros_message = _ros_message;
  {  // cmd
    PyObject * field = PyObject_GetAttrString(_pymsg, "cmd");
    if (!field) {
      return false;
    }
    if (!raptor_dbw_msgs__msg__gear__convert_from_py(field, &ros_message->cmd)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of GearCmd */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._gear_cmd");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GearCmd");
  ...
  {  // cmd
    PyObject * field = NULL;
    field = raptor_dbw_msgs__msg__gear__convert_to_py(&ros_message->cmd);
    if (!field) {
      return NULL;
    }
    {
