...
bool raptor_dbw_msgs__msg__actuator_control_mode__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._actuator_control_mode.ActuatorControlMode", full_classname_dest, 62) == 0);
  }
  raptor_dbw_msgs__msg__ActuatorControlMode * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of ActuatorControlMode */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._actuator_control_mode");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ActuatorControlMode");
