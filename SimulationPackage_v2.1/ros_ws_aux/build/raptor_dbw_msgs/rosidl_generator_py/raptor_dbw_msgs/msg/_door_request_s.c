...
bool raptor_dbw_msgs__msg__door_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._door_request.DoorRequest", full_classname_dest, 45) == 0);
  }
  raptor_dbw_msgs__msg__DoorRequest * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of DoorRequest */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._door_request");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "DoorRequest");
