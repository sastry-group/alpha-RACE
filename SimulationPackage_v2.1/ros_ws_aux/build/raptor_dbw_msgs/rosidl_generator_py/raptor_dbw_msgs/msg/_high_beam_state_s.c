...
bool raptor_dbw_msgs__msg__high_beam_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._high_beam_state.HighBeamState", full_classname_dest, 50) == 0);
  }
  raptor_dbw_msgs__msg__HighBeamState * ros_message = _ros_message;
  {  // value
...
{
  /* NOTE(esteve): Call constructor of HighBeamState */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._high_beam_state");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "HighBeamState");
