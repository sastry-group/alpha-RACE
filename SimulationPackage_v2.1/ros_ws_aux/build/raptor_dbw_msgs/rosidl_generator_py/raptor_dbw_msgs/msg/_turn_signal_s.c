...
bool raptor_dbw_msgs__msg__turn_signal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._turn_signal.TurnSignal", full_classname_dest, 43) == 0);
  }
  raptor_dbw_msgs__msg__TurnSignal * ros_message = _ros_message;
  {  // value
...
PyObject * raptor_dbw_msgs__msg__turn_signal__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._turn_signal");
