...
bool raptor_dbw_msgs__msg__tire_pressure_report__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._tire_pressure_report.TirePressureReport", full_classname_dest, 60) == 0);
  }
  raptor_dbw_msgs__msg__TirePressureReport * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TirePressureReport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._tire_pressure_report");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TirePressureReport");
