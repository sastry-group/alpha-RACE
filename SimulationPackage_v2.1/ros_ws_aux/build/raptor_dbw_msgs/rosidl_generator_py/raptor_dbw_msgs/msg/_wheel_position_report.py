...
class Metaclass_WheelPositionReport(type):
    """Metaclass of message 'WheelPositionReport'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'raptor_dbw_msgs.msg.WheelPositionReport')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__wheel_position_report
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__wheel_position_report
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__wheel_position_report
            cls._TYPE_SUPPORT = module.type_support_msg__msg__wheel_position_report
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__wheel_position_report
...
class WheelPositionReport(metaclass=Metaclass_WheelPositionReport):
    """Message class 'WheelPositionReport'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.wheel_pulses_per_rev = kwargs.get('wheel_pulses_per_rev', float())
    ...
    def __eq__(self, other):
        ...
        if self.rear_right != other.rear_right:
            return False
        if self.wheel_pulses_per_rev != other.wheel_pulses_per_rev:
            return False
        return True
    ...
    @builtins.property
    def wheel_pulses_per_rev(self):
        """Message field 'wheel_pulses_per_rev'."""
        return self._wheel_pulses_per_rev

    @wheel_pulses_per_rev.setter
    def wheel_pulses_per_rev(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'wheel_pulses_per_rev' field must be of type 'float'"
            assert not (value < -3.402823466e+38 or value > 3.402823466e+38) or math.isinf(value), \
                "The 'wheel_pulses_per_rev' field must be a float in [-3.402823466e+38, 3.402823466e+38]"
        self._wheel_pulses_per_rev = value
