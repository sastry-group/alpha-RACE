...
bool raptor_dbw_msgs__msg__gear__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("raptor_dbw_msgs.msg._gear.Gear", full_classname_dest, 30) == 0);
  }
  raptor_dbw_msgs__msg__Gear * ros_message = _ros_message;
  {  // gear
...
{
  /* NOTE(esteve): Call constructor of Gear */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("raptor_dbw_msgs.msg._gear");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Gear");
