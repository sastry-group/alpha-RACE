...
inline void to_flow_style_yaml(
  const HmiGlobalEnableReport & msg,
  std::ostream & out)
{
  out << "{";
  // member: header
  ...
  {
    out << "disable_request: ";
    rosidl_generator_traits::value_to_yaml(msg.disable_request, out);
    out << ", ";
  }
...
inline std::string to_yaml(const HmiGlobalEnableReport & msg, bool use_flow_style = false)
{
