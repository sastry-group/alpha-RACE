  ...
  std::ostream & out)
{
  ...
  // member: vehicle_curvature_actual
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.vehicle_curvature_actual, out);
    out << ", ";
  }
  ...
  // member: max_torque_driver
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.max_torque_driver, out);
    out << ", ";
  }
  ...
  // member: max_torque_motor
  {
    ...
    rosidl_generator_traits::value_to_yaml(msg.max_torque_motor, out);
  }
  out << "}";
...
inline std::string to_yaml(const Steering2Report & msg, bool use_flow_style = false)
{
