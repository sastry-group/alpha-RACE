...
#include "raptor_dbw_msgs/msg/detail/hmi_global_enable_report__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const raptor_dbw_msgs::msg::HmiGlobalEnableReport & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raptor_dbw_msgs::msg::HmiGlobalEnableReport & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_raptor_dbw_msgs
max_serialized_size_HmiGlobalEnableReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs::msg::HmiGlobalEnableReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raptor_dbw_msgs::msg::HmiGlobalEnableReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<raptor_dbw_msgs::msg::HmiGlobalEnableReport *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HmiGlobalEnableReport__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const raptor_dbw_msgs::msg::HmiGlobalEnableReport *>(
...
static size_t _HmiGlobalEnableReport__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_HmiGlobalEnableReport(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HmiGlobalEnableReport__callbacks = {
  "raptor_dbw_msgs::msg",
...
static rosidl_message_type_support_t _HmiGlobalEnableReport__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HmiGlobalEnableReport__callbacks,
...
{
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_HmiGlobalEnableReport__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, HmiGlobalEnableReport)() {
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_HmiGlobalEnableReport__handle;
}
