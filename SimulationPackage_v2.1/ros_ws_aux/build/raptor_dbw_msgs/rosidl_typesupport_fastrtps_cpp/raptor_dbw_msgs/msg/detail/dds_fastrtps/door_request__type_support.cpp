...
#include "raptor_dbw_msgs/msg/detail/door_request__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const raptor_dbw_msgs::msg::DoorRequest & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  raptor_dbw_msgs::msg::DoorRequest & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs::msg::DoorRequest;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const raptor_dbw_msgs::msg::DoorRequest *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<raptor_dbw_msgs::msg::DoorRequest *>(
    untyped_ros_message);
...
{
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_DoorRequest__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, DoorRequest)() {
  return &raptor_dbw_msgs::msg::typesupport_fastrtps_cpp::_DoorRequest__handle;
}
