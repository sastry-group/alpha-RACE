...
#include "raptor_dbw_msgs/msg/detail/steering_report__rosidl_typesupport_fastrtps_c.h"
...
using _SteeringReport__ros_msg_type = raptor_dbw_msgs__msg__SteeringReport;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SteeringReport__ros_msg_type * ros_message = static_cast<const _SteeringReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: fault_steering_system
  {
    cdr << (ros_message->fault_steering_system ? true : false);
  }

  // Field name: overheat_prevention_mode
  {
  ...
  // Field name: steering_overheat_warning
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SteeringReport__ros_msg_type * ros_message = static_cast<_SteeringReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_raptor_dbw_msgs__msg__SteeringReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SteeringReport__ros_msg_type * ros_message = static_cast<const _SteeringReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SteeringReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__SteeringReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_raptor_dbw_msgs
size_t max_serialized_size_raptor_dbw_msgs__msg__SteeringReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs__msg__SteeringReport;
    is_plain =
      (
...
static size_t _SteeringReport__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_raptor_dbw_msgs__msg__SteeringReport(
...
static message_type_support_callbacks_t __callbacks_SteeringReport = {
  "raptor_dbw_msgs::msg",
  "SteeringReport",
...
static rosidl_message_type_support_t _SteeringReport__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SteeringReport,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, raptor_dbw_msgs, msg, SteeringReport)() {
  return &_SteeringReport__type_support;
}
