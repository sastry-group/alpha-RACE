...
#include "raptor_dbw_msgs/msg/detail/door_request__rosidl_typesupport_fastrtps_c.h"
...
using _DoorRequest__ros_msg_type = raptor_dbw_msgs__msg__DoorRequest;
...
static uint32_t _DoorRequest__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__DoorRequest(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs__msg__DoorRequest;
    is_plain =
      (
...
static size_t _DoorRequest__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_raptor_dbw_msgs__msg__DoorRequest(
