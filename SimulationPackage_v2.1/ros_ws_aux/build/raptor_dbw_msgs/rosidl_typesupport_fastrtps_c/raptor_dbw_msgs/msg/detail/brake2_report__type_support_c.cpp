...
#include "raptor_dbw_msgs/msg/detail/brake2_report__rosidl_typesupport_fastrtps_c.h"
...
using _Brake2Report__ros_msg_type = raptor_dbw_msgs__msg__Brake2Report;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Brake2Report__ros_msg_type * ros_message = static_cast<const _Brake2Report__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: estimated_road_slope
  {
    cdr << ros_message->estimated_road_slope;
  }

  // Field name: speed_set_point
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Brake2Report__ros_msg_type * ros_message = static_cast<_Brake2Report__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_raptor_dbw_msgs__msg__Brake2Report(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Brake2Report__ros_msg_type * ros_message = static_cast<const _Brake2Report__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Brake2Report__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__Brake2Report(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_raptor_dbw_msgs
size_t max_serialized_size_raptor_dbw_msgs__msg__Brake2Report(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs__msg__Brake2Report;
    is_plain =
      (
      offsetof(DataType, speed_set_point) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Brake2Report__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_raptor_dbw_msgs__msg__Brake2Report(
...
static message_type_support_callbacks_t __callbacks_Brake2Report = {
  "raptor_dbw_msgs::msg",
  "Brake2Report",
...
static rosidl_message_type_support_t _Brake2Report__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Brake2Report,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, raptor_dbw_msgs, msg, Brake2Report)() {
  return &_Brake2Report__type_support;
}
