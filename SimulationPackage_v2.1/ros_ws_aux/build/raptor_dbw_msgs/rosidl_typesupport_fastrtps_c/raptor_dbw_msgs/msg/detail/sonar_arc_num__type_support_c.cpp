...
#include "raptor_dbw_msgs/msg/detail/sonar_arc_num__rosidl_typesupport_fastrtps_c.h"
...
using _SonarArcNum__ros_msg_type = raptor_dbw_msgs__msg__SonarArcNum;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SonarArcNum__ros_msg_type * ros_message = static_cast<const _SonarArcNum__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SonarArcNum__ros_msg_type * ros_message = static_cast<_SonarArcNum__ros_msg_type *>(untyped_ros_message);
  // Field name: status
  {
    cdr >> ros_message->status;
  }
...
static uint32_t _SonarArcNum__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__SonarArcNum(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs__msg__SonarArcNum;
    is_plain =
      (
...
static size_t _SonarArcNum__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_raptor_dbw_msgs__msg__SonarArcNum(
...
static message_type_support_callbacks_t __callbacks_SonarArcNum = {
  "raptor_dbw_msgs::msg",
  "SonarArcNum",
...
static rosidl_message_type_support_t _SonarArcNum__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SonarArcNum,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, raptor_dbw_msgs, msg, SonarArcNum)() {
  return &_SonarArcNum__type_support;
}
