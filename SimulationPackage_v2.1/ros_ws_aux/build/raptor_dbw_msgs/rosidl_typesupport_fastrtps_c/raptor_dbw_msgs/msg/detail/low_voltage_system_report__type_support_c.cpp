...
#include "raptor_dbw_msgs/msg/detail/low_voltage_system_report__rosidl_typesupport_fastrtps_c.h"
...
using _LowVoltageSystemReport__ros_msg_type = raptor_dbw_msgs__msg__LowVoltageSystemReport;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LowVoltageSystemReport__ros_msg_type * ros_message = static_cast<const _LowVoltageSystemReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: dbw_battery_volts
  {
    cdr << ros_message->dbw_battery_volts;
  }

  // Field name: vehicle_battery_volts
  {
    cdr << ros_message->vehicle_battery_volts;
  }

  // Field name: vehicle_battery_current
  {
    cdr << ros_message->vehicle_battery_current;
  }

  // Field name: vehicle_alternator_current
  {
    cdr << ros_message->vehicle_alternator_current;
  }

  // Field name: dcdc_current
  {
    cdr << ros_message->dcdc_current;
  }

  // Field name: alternator_current
  {
    cdr << ros_message->alternator_current;
  }

  // Field name: aux_inverter_contactor
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LowVoltageSystemReport__ros_msg_type * ros_message = static_cast<_LowVoltageSystemReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_raptor_dbw_msgs__msg__LowVoltageSystemReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LowVoltageSystemReport__ros_msg_type * ros_message = static_cast<const _LowVoltageSystemReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LowVoltageSystemReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_raptor_dbw_msgs__msg__LowVoltageSystemReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_raptor_dbw_msgs
size_t max_serialized_size_raptor_dbw_msgs__msg__LowVoltageSystemReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = raptor_dbw_msgs__msg__LowVoltageSystemReport;
    is_plain =
      (
      offsetof(DataType, aux_inverter_contactor) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _LowVoltageSystemReport__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_raptor_dbw_msgs__msg__LowVoltageSystemReport(
...
static message_type_support_callbacks_t __callbacks_LowVoltageSystemReport = {
  "raptor_dbw_msgs::msg",
...
static rosidl_message_type_support_t _LowVoltageSystemReport__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LowVoltageSystemReport,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, raptor_dbw_msgs, msg, LowVoltageSystemReport)() {
  return &_LowVoltageSystemReport__type_support;
}
