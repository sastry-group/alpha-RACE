...
raptor_dbw_msgs__msg__DoorState__create()
{
  ...
  raptor_dbw_msgs__msg__DoorState * msg = (raptor_dbw_msgs__msg__DoorState *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__DoorState), allocator.state);
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__DoorState__Sequence__init(raptor_dbw_msgs__msg__DoorState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__DoorState *)allocator.zero_allocate(size, sizeof(raptor_dbw_msgs__msg__DoorState), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raptor_dbw_msgs__msg__DoorState__Sequence * array = (raptor_dbw_msgs__msg__DoorState__Sequence *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__DoorState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__DoorState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__DoorState * data =
      (raptor_dbw_msgs__msg__DoorState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__DoorState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__DoorState__fini(&output->data[i]);
        }
        return false;
      }
    }
