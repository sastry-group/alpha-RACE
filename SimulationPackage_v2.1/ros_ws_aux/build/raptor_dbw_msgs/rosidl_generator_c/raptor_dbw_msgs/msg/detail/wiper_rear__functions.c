...
raptor_dbw_msgs__msg__WiperRear__create()
{
  ...
  raptor_dbw_msgs__msg__WiperRear * msg = (raptor_dbw_msgs__msg__WiperRear *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__WiperRear), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(raptor_dbw_msgs__msg__WiperRear));
  bool success = raptor_dbw_msgs__msg__WiperRear__init(msg);
  if (!success) {
...
raptor_dbw_msgs__msg__WiperRear__destroy(raptor_dbw_msgs__msg__WiperRear * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    raptor_dbw_msgs__msg__WiperRear__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
raptor_dbw_msgs__msg__WiperRear__Sequence__init(raptor_dbw_msgs__msg__WiperRear__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raptor_dbw_msgs__msg__WiperRear * data = NULL;

  if (size) {
    data = (raptor_dbw_msgs__msg__WiperRear *)allocator.zero_allocate(size, sizeof(raptor_dbw_msgs__msg__WiperRear), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = raptor_dbw_msgs__msg__WiperRear__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        raptor_dbw_msgs__msg__WiperRear__fini(&data[i - 1]);
      }
...
raptor_dbw_msgs__msg__WiperRear__Sequence__fini(raptor_dbw_msgs__msg__WiperRear__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      raptor_dbw_msgs__msg__WiperRear__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raptor_dbw_msgs__msg__WiperRear__Sequence * array = (raptor_dbw_msgs__msg__WiperRear__Sequence *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__WiperRear__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = raptor_dbw_msgs__msg__WiperRear__Sequence__init(array, size);
  if (!success) {
...
raptor_dbw_msgs__msg__WiperRear__Sequence__destroy(raptor_dbw_msgs__msg__WiperRear__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    raptor_dbw_msgs__msg__WiperRear__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
raptor_dbw_msgs__msg__WiperRear__Sequence__are_equal(const raptor_dbw_msgs__msg__WiperRear__Sequence * lhs, const raptor_dbw_msgs__msg__WiperRear__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!raptor_dbw_msgs__msg__WiperRear__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  raptor_dbw_msgs__msg__WiperRear__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(raptor_dbw_msgs__msg__WiperRear);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    raptor_dbw_msgs__msg__WiperRear * data =
      (raptor_dbw_msgs__msg__WiperRear *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__WiperRear__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__WiperRear__fini(&output->data[i]);
        }
        return false;
      }
    }
