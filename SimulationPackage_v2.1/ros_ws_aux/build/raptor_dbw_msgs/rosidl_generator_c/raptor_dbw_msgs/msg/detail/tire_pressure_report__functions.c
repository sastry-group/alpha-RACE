...
raptor_dbw_msgs__msg__TirePressureReport__create()
{
  ...
  raptor_dbw_msgs__msg__TirePressureReport * msg = (raptor_dbw_msgs__msg__TirePressureReport *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__TirePressureReport), allocator.state);
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__TirePressureReport__Sequence__init(raptor_dbw_msgs__msg__TirePressureReport__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__TirePressureReport *)allocator.zero_allocate(size, sizeof(raptor_dbw_msgs__msg__TirePressureReport), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raptor_dbw_msgs__msg__TirePressureReport__Sequence * array = (raptor_dbw_msgs__msg__TirePressureReport__Sequence *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__TirePressureReport__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__TirePressureReport__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__TirePressureReport * data =
      (raptor_dbw_msgs__msg__TirePressureReport *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__TirePressureReport__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__TirePressureReport__fini(&output->data[i]);
        }
        return false;
      }
    }
