...
raptor_dbw_msgs__msg__HighBeamState__create()
{
  ...
  raptor_dbw_msgs__msg__HighBeamState * msg = (raptor_dbw_msgs__msg__HighBeamState *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__HighBeamState), allocator.state);
  if (!msg) {
    return NULL;
  }
...
raptor_dbw_msgs__msg__HighBeamState__Sequence__init(raptor_dbw_msgs__msg__HighBeamState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (raptor_dbw_msgs__msg__HighBeamState *)allocator.zero_allocate(size, sizeof(raptor_dbw_msgs__msg__HighBeamState), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  raptor_dbw_msgs__msg__HighBeamState__Sequence * array = (raptor_dbw_msgs__msg__HighBeamState__Sequence *)allocator.allocate(sizeof(raptor_dbw_msgs__msg__HighBeamState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  raptor_dbw_msgs__msg__HighBeamState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    raptor_dbw_msgs__msg__HighBeamState * data =
      (raptor_dbw_msgs__msg__HighBeamState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!raptor_dbw_msgs__msg__HighBeamState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          raptor_dbw_msgs__msg__HighBeamState__fini(&output->data[i]);
        }
        return false;
      }
    }
