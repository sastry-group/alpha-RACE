...
void raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_init_function(
...
void raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_fini_function(void * message_memory)
{
  raptor_dbw_msgs__msg__AcceleratorPedalCmd__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_member_array[10] = {
  {
    "pedal_cmd",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_members = {
  "raptor_dbw_msgs__msg",  // message namespace
  "AcceleratorPedalCmd",  // message name
  10,  // number of fields
  sizeof(raptor_dbw_msgs__msg__AcceleratorPedalCmd),
  raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_member_array,  // message members
  raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_init_function,  // function to initialize message memory (memory has to be allocated)
  raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_type_support_handle = {
  0,
  &raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, raptor_dbw_msgs, msg, AcceleratorPedalCmd)() {
  raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_member_array[7].members_ =
  ...
  if (!raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_type_support_handle.typesupport_identifier) {
    raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &raptor_dbw_msgs__msg__AcceleratorPedalCmd__rosidl_typesupport_introspection_c__AcceleratorPedalCmd_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
