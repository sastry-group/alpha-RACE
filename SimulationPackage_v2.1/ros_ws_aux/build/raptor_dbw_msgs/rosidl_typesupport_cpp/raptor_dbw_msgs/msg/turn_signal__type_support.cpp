...
static const _TurnSignal_type_support_symbol_names_t _TurnSignal_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, raptor_dbw_msgs, msg, TurnSignal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, raptor_dbw_msgs, msg, TurnSignal)),
  }
};
...
get_message_type_support_handle<raptor_dbw_msgs::msg::TurnSignal>()
{
  return &::raptor_dbw_msgs::msg::rosidl_typesupport_cpp::TurnSignal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, raptor_dbw_msgs, msg, TurnSignal)() {
  return get_message_type_support_handle<raptor_dbw_msgs::msg::TurnSignal>();
}
