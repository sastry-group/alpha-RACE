...
#include "npc_controller_msgs/msg/detail/misc_report__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = npc_controller_msgs::msg::MiscReport;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const npc_controller_msgs::msg::MiscReport *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<npc_controller_msgs::msg::MiscReport *>(
    untyped_ros_message);
...
{
  return &npc_controller_msgs::msg::typesupport_fastrtps_cpp::_MiscReport__handle;
}
