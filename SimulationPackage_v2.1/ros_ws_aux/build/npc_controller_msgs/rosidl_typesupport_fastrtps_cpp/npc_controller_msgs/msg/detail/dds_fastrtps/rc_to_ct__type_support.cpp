...
#include "npc_controller_msgs/msg/detail/rc_to_ct__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const npc_controller_msgs::msg::RcToCt & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  npc_controller_msgs::msg::RcToCt & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = npc_controller_msgs::msg::RcToCt;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const npc_controller_msgs::msg::RcToCt *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<npc_controller_msgs::msg::RcToCt *>(
    untyped_ros_message);
...
static size_t _RcToCt__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RcToCt(full_bounded, is_plain, 0);
...
{
  return &npc_controller_msgs::msg::typesupport_fastrtps_cpp::_RcToCt__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, npc_controller_msgs, msg, RcToCt)() {
  return &npc_controller_msgs::msg::typesupport_fastrtps_cpp::_RcToCt__handle;
}
