...
#ifndef NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__TRAITS_HPP_
#define NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__TRAITS_HPP_
...
inline std::string to_yaml(const PtReport & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const npc_controller_msgs::msg::PtReport & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const npc_controller_msgs::msg::PtReport & msg)
{
  return npc_controller_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<npc_controller_msgs::msg::PtReport>()
{
  return "npc_controller_msgs::msg::PtReport";
}

template<>
inline const char * name<npc_controller_msgs::msg::PtReport>()
{
  return "npc_controller_msgs/msg/PtReport";
}

template<>
struct has_fixed_size<npc_controller_msgs::msg::PtReport>
  : std::integral_constant<bool, has_fixed_size<builtin_interfaces::msg::Time>::value> {};

template<>
struct has_bounded_size<npc_controller_msgs::msg::PtReport>
  : std::integral_constant<bool, has_bounded_size<builtin_interfaces::msg::Time>::value> {};

template<>
struct is_message<npc_controller_msgs::msg::PtReport>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__TRAITS_HPP_
