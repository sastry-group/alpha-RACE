...
#ifndef NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__STRUCT_HPP_
#define NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__npc_controller_msgs__msg__PtReport __attribute__((deprecated))
#else
# define DEPRECATED__npc_controller_msgs__msg__PtReport __declspec(deprecated)
#endif
...
struct PtReport_
{
  ...
  // pointer types
  using RawPtr =
    npc_controller_msgs::msg::PtReport_<ContainerAllocator> *;
  using ConstRawPtr =
    const npc_controller_msgs::msg::PtReport_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      npc_controller_msgs::msg::PtReport_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__npc_controller_msgs__msg__PtReport
    std::shared_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__npc_controller_msgs__msg__PtReport
    std::shared_ptr<npc_controller_msgs::msg::PtReport_<ContainerAllocator> const>
...
using PtReport =
  npc_controller_msgs::msg::PtReport_<std::allocator<void>>;
...
#endif  // NPC_CONTROLLER_MSGS__MSG__DETAIL__PT_REPORT__STRUCT_HPP_
