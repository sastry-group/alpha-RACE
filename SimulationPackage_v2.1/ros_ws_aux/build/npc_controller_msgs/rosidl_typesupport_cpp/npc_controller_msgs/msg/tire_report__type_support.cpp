...
static const _TireReport_type_support_symbol_names_t _TireReport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, npc_controller_msgs, msg, TireReport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, npc_controller_msgs, msg, TireReport)),
  }
};
...
{
  return &::npc_controller_msgs::msg::rosidl_typesupport_cpp::TireReport_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, npc_controller_msgs, msg, TireReport)() {
  return get_message_type_support_handle<npc_controller_msgs::msg::TireReport>();
}
