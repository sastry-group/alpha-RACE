...
: ${AMENT_CURRENT_PREFIX:="/root/ros_ws_aux/install/raptor_dbw_can"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/raptor_dbw_can/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/raptor_dbw_can/environment/path.sh"
