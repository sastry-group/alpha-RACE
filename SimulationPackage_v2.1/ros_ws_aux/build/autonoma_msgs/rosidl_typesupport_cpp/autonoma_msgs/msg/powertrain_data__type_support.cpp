...
static const _PowertrainData_type_support_symbol_names_t _PowertrainData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonoma_msgs, msg, PowertrainData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autonoma_msgs, msg, PowertrainData)),
  }
};
...
{
  return &::autonoma_msgs::msg::rosidl_typesupport_cpp::PowertrainData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autonoma_msgs, msg, PowertrainData)() {
  return get_message_type_support_handle<autonoma_msgs::msg::PowertrainData>();
}
