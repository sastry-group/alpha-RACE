...
static const _ToRaptor_type_support_symbol_names_t _ToRaptor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonoma_msgs, msg, ToRaptor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autonoma_msgs, msg, ToRaptor)),
  }
};
...
{
  return &::autonoma_msgs::msg::rosidl_typesupport_cpp::ToRaptor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autonoma_msgs, msg, ToRaptor)() {
  return get_message_type_support_handle<autonoma_msgs::msg::ToRaptor>();
}
