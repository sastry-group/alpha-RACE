...
#include "autonoma_msgs/msg/detail/race_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autonoma_msgs::msg::RaceControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autonoma_msgs::msg::RaceControl & ros_message)
{
  // Member: header
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_autonoma_msgs
max_serialized_size_RaceControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autonoma_msgs::msg::RaceControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autonoma_msgs::msg::RaceControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autonoma_msgs::msg::RaceControl *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RaceControl__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autonoma_msgs::msg::RaceControl *>(
...
static size_t _RaceControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RaceControl(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RaceControl__callbacks = {
  "autonoma_msgs::msg",
  "RaceControl",
...
static rosidl_message_type_support_t _RaceControl__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RaceControl__callbacks,
...
{
  return &autonoma_msgs::msg::typesupport_fastrtps_cpp::_RaceControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonoma_msgs, msg, RaceControl)() {
  return &autonoma_msgs::msg::typesupport_fastrtps_cpp::_RaceControl__handle;
}
