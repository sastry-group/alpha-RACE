...
#include "autonoma_msgs/msg/detail/ground_truth_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autonoma_msgs::msg::GroundTruth &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autonoma_msgs::msg::GroundTruthArray & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: vehicles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      autonoma_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autonoma_msgs::msg::GroundTruthArray & ros_message)
{
  // Member: header
  ...
  // Member: vehicles
  {
    ...
    for (size_t i = 0; i < size; i++) {
      autonoma_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: vehicles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        autonoma_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: vehicles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autonoma_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GroundTruth(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autonoma_msgs::msg::GroundTruthArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autonoma_msgs::msg::GroundTruthArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autonoma_msgs::msg::GroundTruthArray *>(
    untyped_ros_message);
...
{
  return &autonoma_msgs::msg::typesupport_fastrtps_cpp::_GroundTruthArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autonoma_msgs, msg, GroundTruthArray)() {
  return &autonoma_msgs::msg::typesupport_fastrtps_cpp::_GroundTruthArray__handle;
}
