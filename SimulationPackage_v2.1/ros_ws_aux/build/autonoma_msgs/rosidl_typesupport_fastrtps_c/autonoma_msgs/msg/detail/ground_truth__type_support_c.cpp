...
#include "autonoma_msgs/msg/detail/ground_truth__rosidl_typesupport_fastrtps_c.h"
...
using _GroundTruth__ros_msg_type = autonoma_msgs__msg__GroundTruth;
...
static uint32_t _GroundTruth__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autonoma_msgs__msg__GroundTruth(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autonoma_msgs__msg__GroundTruth;
    is_plain =
      (
...
static size_t _GroundTruth__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autonoma_msgs__msg__GroundTruth(
