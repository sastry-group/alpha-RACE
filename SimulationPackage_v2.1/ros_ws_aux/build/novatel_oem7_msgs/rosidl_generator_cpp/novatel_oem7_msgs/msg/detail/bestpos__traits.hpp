...
#ifndef NOVATEL_OEM7_MSGS__MSG__DETAIL__BESTPOS__TRAITS_HPP_
#define NOVATEL_OEM7_MSGS__MSG__DETAIL__BESTPOS__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "lat_stdev: ";
    rosidl_generator_traits::value_to_yaml(msg.lat_stdev, out);
    out << ", ";
  }
  ...
  {
    out << "lon_stdev: ";
    rosidl_generator_traits::value_to_yaml(msg.lon_stdev, out);
    out << ", ";
  }
  ...
  {
    out << "hgt_stdev: ";
    rosidl_generator_traits::value_to_yaml(msg.hgt_stdev, out);
    out << ", ";
  }
  ...
  {
    out << "num_sol_l1_svs: ";
    rosidl_generator_traits::value_to_yaml(msg.num_sol_l1_svs, out);
    out << ", ";
  }
...
inline std::string to_yaml(const novatel_oem7_msgs::msg::BESTPOS & msg)
{
  return novatel_oem7_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<novatel_oem7_msgs::msg::BESTPOS>()
{
  return "novatel_oem7_msgs::msg::BESTPOS";
}

template<>
inline const char * name<novatel_oem7_msgs::msg::BESTPOS>()
{
  return "novatel_oem7_msgs/msg/BESTPOS";
}

template<>
struct has_fixed_size<novatel_oem7_msgs::msg::BESTPOS>
...
template<>
struct has_bounded_size<novatel_oem7_msgs::msg::BESTPOS>
...
template<>
struct is_message<novatel_oem7_msgs::msg::BESTPOS>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NOVATEL_OEM7_MSGS__MSG__DETAIL__BESTPOS__TRAITS_HPP_
