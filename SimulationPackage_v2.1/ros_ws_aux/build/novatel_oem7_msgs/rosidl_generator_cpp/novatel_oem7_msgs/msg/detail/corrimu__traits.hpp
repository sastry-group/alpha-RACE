...
#ifndef NOVATEL_OEM7_MSGS__MSG__DETAIL__CORRIMU__TRAITS_HPP_
#define NOVATEL_OEM7_MSGS__MSG__DETAIL__CORRIMU__TRAITS_HPP_
  ...
  std::ostream & out)
{
  ...
  {
    out << "imu_data_count: ";
    rosidl_generator_traits::value_to_yaml(msg.imu_data_count, out);
    out << ", ";
  }
...
inline std::string to_yaml(const CORRIMU & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const novatel_oem7_msgs::msg::CORRIMU & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const novatel_oem7_msgs::msg::CORRIMU & msg)
{
  return novatel_oem7_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<novatel_oem7_msgs::msg::CORRIMU>()
{
  return "novatel_oem7_msgs::msg::CORRIMU";
}

template<>
inline const char * name<novatel_oem7_msgs::msg::CORRIMU>()
{
  return "novatel_oem7_msgs/msg/CORRIMU";
}

template<>
struct has_fixed_size<novatel_oem7_msgs::msg::CORRIMU>
...
template<>
struct has_bounded_size<novatel_oem7_msgs::msg::CORRIMU>
...
template<>
struct is_message<novatel_oem7_msgs::msg::CORRIMU>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // NOVATEL_OEM7_MSGS__MSG__DETAIL__CORRIMU__TRAITS_HPP_
