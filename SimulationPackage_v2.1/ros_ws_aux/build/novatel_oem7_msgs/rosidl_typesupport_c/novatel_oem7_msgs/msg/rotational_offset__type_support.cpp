...
static const _RotationalOffset_type_support_symbol_names_t _RotationalOffset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, RotationalOffset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, novatel_oem7_msgs, msg, RotationalOffset)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, novatel_oem7_msgs, msg, RotationalOffset)() {
  return &::novatel_oem7_msgs::msg::rosidl_typesupport_c::RotationalOffset_message_type_support_handle;
}
