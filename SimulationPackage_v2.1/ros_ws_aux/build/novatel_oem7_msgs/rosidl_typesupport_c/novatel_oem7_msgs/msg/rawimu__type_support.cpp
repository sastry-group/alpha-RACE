...
static const _RAWIMU_type_support_symbol_names_t _RAWIMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, RAWIMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, novatel_oem7_msgs, msg, RAWIMU)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, novatel_oem7_msgs, msg, RAWIMU)() {
  return &::novatel_oem7_msgs::msg::rosidl_typesupport_c::RAWIMU_message_type_support_handle;
}
