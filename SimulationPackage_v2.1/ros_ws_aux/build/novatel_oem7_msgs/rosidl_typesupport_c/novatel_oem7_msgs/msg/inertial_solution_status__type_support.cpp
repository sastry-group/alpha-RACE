...
static const _InertialSolutionStatus_type_support_symbol_names_t _InertialSolutionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, InertialSolutionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, novatel_oem7_msgs, msg, InertialSolutionStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, novatel_oem7_msgs, msg, InertialSolutionStatus)() {
  return &::novatel_oem7_msgs::msg::rosidl_typesupport_c::InertialSolutionStatus_message_type_support_handle;
}
