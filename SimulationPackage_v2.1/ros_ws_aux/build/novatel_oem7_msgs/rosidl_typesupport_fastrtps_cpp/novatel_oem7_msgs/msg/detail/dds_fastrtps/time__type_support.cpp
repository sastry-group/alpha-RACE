...
#include "novatel_oem7_msgs/msg/detail/time__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const novatel_oem7_msgs::msg::TIME & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  novatel_oem7_msgs::msg::TIME & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs::msg::TIME;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const novatel_oem7_msgs::msg::TIME *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<novatel_oem7_msgs::msg::TIME *>(
    untyped_ros_message);
...
{
  return &novatel_oem7_msgs::msg::typesupport_fastrtps_cpp::_TIME__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, novatel_oem7_msgs, msg, TIME)() {
  return &novatel_oem7_msgs::msg::typesupport_fastrtps_cpp::_TIME__handle;
}
