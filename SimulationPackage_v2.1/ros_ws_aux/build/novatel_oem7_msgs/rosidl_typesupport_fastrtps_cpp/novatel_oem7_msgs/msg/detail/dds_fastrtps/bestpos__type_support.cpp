...
#include "novatel_oem7_msgs/msg/detail/bestpos__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const novatel_oem7_msgs::msg::BESTPOS & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  novatel_oem7_msgs::msg::BESTPOS & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs::msg::BESTPOS;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const novatel_oem7_msgs::msg::BESTPOS *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<novatel_oem7_msgs::msg::BESTPOS *>(
    untyped_ros_message);
...
get_message_type_support_handle<novatel_oem7_msgs::msg::BESTPOS>()
{
  return &novatel_oem7_msgs::msg::typesupport_fastrtps_cpp::_BESTPOS__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, novatel_oem7_msgs, msg, BESTPOS)() {
  return &novatel_oem7_msgs::msg::typesupport_fastrtps_cpp::_BESTPOS__handle;
}
