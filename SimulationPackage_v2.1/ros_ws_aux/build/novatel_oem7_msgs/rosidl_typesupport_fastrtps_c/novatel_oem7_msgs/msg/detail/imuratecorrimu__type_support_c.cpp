...
#include "novatel_oem7_msgs/msg/detail/imuratecorrimu__rosidl_typesupport_fastrtps_c.h"
...
using _IMURATECORRIMU__ros_msg_type = novatel_oem7_msgs__msg__IMURATECORRIMU;

static bool _IMURATECORRIMU__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _IMURATECORRIMU__ros_msg_type * ros_message = static_cast<const _IMURATECORRIMU__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _IMURATECORRIMU__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _IMURATECORRIMU__ros_msg_type * ros_message = static_cast<_IMURATECORRIMU__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_novatel_oem7_msgs__msg__IMURATECORRIMU(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IMURATECORRIMU__ros_msg_type * ros_message = static_cast<const _IMURATECORRIMU__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IMURATECORRIMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_novatel_oem7_msgs__msg__IMURATECORRIMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_novatel_oem7_msgs
size_t max_serialized_size_novatel_oem7_msgs__msg__IMURATECORRIMU(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs__msg__IMURATECORRIMU;
    is_plain =
      (
      offsetof(DataType, vertical_acc) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _IMURATECORRIMU__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_novatel_oem7_msgs__msg__IMURATECORRIMU(
...
static message_type_support_callbacks_t __callbacks_IMURATECORRIMU = {
  "novatel_oem7_msgs::msg",
  "IMURATECORRIMU",
  _IMURATECORRIMU__cdr_serialize,
  _IMURATECORRIMU__cdr_deserialize,
  _IMURATECORRIMU__get_serialized_size,
  _IMURATECORRIMU__max_serialized_size
};

static rosidl_message_type_support_t _IMURATECORRIMU__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_IMURATECORRIMU,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, IMURATECORRIMU)() {
  return &_IMURATECORRIMU__type_support;
}
