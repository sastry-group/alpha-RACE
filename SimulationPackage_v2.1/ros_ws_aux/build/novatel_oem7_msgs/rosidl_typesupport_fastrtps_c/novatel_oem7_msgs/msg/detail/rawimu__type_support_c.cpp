...
#include "novatel_oem7_msgs/msg/detail/rawimu__rosidl_typesupport_fastrtps_c.h"
...
using _RAWIMU__ros_msg_type = novatel_oem7_msgs__msg__RAWIMU;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: gnss_week
  {
    cdr << ros_message->gnss_week;
  }

  // Field name: gnss_seconds
  {
...
size_t get_serialized_size_novatel_oem7_msgs__msg__RAWIMU(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _RAWIMU__ros_msg_type * ros_message = static_cast<const _RAWIMU__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _RAWIMU__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_novatel_oem7_msgs__msg__RAWIMU(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_novatel_oem7_msgs
size_t max_serialized_size_novatel_oem7_msgs__msg__RAWIMU(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs__msg__RAWIMU;
    is_plain =
      (
...
static size_t _RAWIMU__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_novatel_oem7_msgs__msg__RAWIMU(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, RAWIMU)() {
