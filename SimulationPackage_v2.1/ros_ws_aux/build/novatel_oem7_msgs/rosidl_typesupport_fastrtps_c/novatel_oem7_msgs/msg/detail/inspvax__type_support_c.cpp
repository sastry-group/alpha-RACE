...
#include "novatel_oem7_msgs/msg/detail/inspvax__rosidl_typesupport_fastrtps_c.h"
...
#include "novatel_oem7_msgs/msg/detail/inertial_solution_status__functions.h"  // ins_status
...
using _INSPVAX__ros_msg_type = novatel_oem7_msgs__msg__INSPVAX;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _INSPVAX__ros_msg_type * ros_message = static_cast<const _INSPVAX__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _INSPVAX__ros_msg_type * ros_message = static_cast<_INSPVAX__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_novatel_oem7_msgs__msg__INSPVAX(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _INSPVAX__ros_msg_type * ros_message = static_cast<const _INSPVAX__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _INSPVAX__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_novatel_oem7_msgs__msg__INSPVAX(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_novatel_oem7_msgs
size_t max_serialized_size_novatel_oem7_msgs__msg__INSPVAX(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs__msg__INSPVAX;
    is_plain =
      (
...
static size_t _INSPVAX__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_novatel_oem7_msgs__msg__INSPVAX(
...
static message_type_support_callbacks_t __callbacks_INSPVAX = {
...
static rosidl_message_type_support_t _INSPVAX__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, INSPVAX)() {
  return &_INSPVAX__type_support;
}
