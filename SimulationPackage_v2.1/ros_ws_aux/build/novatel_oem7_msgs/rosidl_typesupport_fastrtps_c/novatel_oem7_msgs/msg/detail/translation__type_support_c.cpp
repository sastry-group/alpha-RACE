...
#include "novatel_oem7_msgs/msg/detail/translation__rosidl_typesupport_fastrtps_c.h"
...
#include "novatel_oem7_msgs/msg/detail/ins_source_status__functions.h"  // translation_source
#include "novatel_oem7_msgs/msg/detail/translation_offset__functions.h"  // translation
...
size_t get_serialized_size_novatel_oem7_msgs__msg__TranslationOffset(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_novatel_oem7_msgs__msg__TranslationOffset(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, TranslationOffset)();


using _Translation__ros_msg_type = novatel_oem7_msgs__msg__Translation;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Translation__ros_msg_type * ros_message = static_cast<const _Translation__ros_msg_type *>(untyped_ros_message);
  // Field name: translation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, TranslationOffset
      )()->data);
  ...
  // Field name: x_uncertainty
  {
    cdr << ros_message->x_uncertainty;
  }

  // Field name: y_uncertainty
  {
    cdr << ros_message->y_uncertainty;
  }

  // Field name: z_uncertainty
  {
    cdr << ros_message->z_uncertainty;
  }

  // Field name: translation_source
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->translation_source, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _Translation__ros_msg_type * ros_message = static_cast<_Translation__ros_msg_type *>(untyped_ros_message);
  // Field name: translation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_novatel_oem7_msgs__msg__TranslationOffset(
...
static uint32_t _Translation__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_novatel_oem7_msgs__msg__Translation(
  ...
  size_t current_alignment)
{
  ...
  // member: translation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_novatel_oem7_msgs__msg__TranslationOffset(
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs__msg__Translation;
    is_plain =
      (
...
static size_t _Translation__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_novatel_oem7_msgs__msg__Translation(
...
static message_type_support_callbacks_t __callbacks_Translation = {
