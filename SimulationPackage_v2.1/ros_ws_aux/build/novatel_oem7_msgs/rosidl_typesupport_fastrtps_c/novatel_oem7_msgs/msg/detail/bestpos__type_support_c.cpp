...
#include "novatel_oem7_msgs/msg/detail/bestpos__rosidl_typesupport_fastrtps_c.h"
...
using _BESTPOS__ros_msg_type = novatel_oem7_msgs__msg__BESTPOS;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: lat_stdev
  {
    cdr << ros_message->lat_stdev;
  }

  // Field name: lon_stdev
  {
    cdr << ros_message->lon_stdev;
  }

  // Field name: hgt_stdev
  {
    cdr << ros_message->hgt_stdev;
  }
  ...
  // Field name: num_sol_l1_svs
  {
    cdr << ros_message->num_sol_l1_svs;
  }
  ...
  void * untyped_ros_message)
{
  ...
  _BESTPOS__ros_msg_type * ros_message = static_cast<_BESTPOS__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_novatel_oem7_msgs__msg__BESTPOS(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BESTPOS__ros_msg_type * ros_message = static_cast<const _BESTPOS__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name hgt
  {
    size_t item_size = sizeof(ros_message->hgt);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name undulation
  ...
  // field.name lat_stdev
  {
    size_t item_size = sizeof(ros_message->lat_stdev);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name lon_stdev
  {
    size_t item_size = sizeof(ros_message->lon_stdev);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name hgt_stdev
  {
    size_t item_size = sizeof(ros_message->hgt_stdev);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name stn_id
  ...
  // field.name num_sol_l1_svs
  {
    size_t item_size = sizeof(ros_message->num_sol_l1_svs);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name num_sol_multi_svs
...
static uint32_t _BESTPOS__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_novatel_oem7_msgs__msg__BESTPOS(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_novatel_oem7_msgs
size_t max_serialized_size_novatel_oem7_msgs__msg__BESTPOS(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = novatel_oem7_msgs__msg__BESTPOS;
    is_plain =
      (
...
static size_t _BESTPOS__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_novatel_oem7_msgs__msg__BESTPOS(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, novatel_oem7_msgs, msg, BESTPOS)() {
