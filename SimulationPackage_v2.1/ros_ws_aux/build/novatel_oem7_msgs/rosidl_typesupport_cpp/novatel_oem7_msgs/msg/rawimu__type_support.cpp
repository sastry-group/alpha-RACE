...
static const _RAWIMU_type_support_symbol_names_t _RAWIMU_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, novatel_oem7_msgs, msg, RAWIMU)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, novatel_oem7_msgs, msg, RAWIMU)),
  }
};
...
{
  return &::novatel_oem7_msgs::msg::rosidl_typesupport_cpp::RAWIMU_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, novatel_oem7_msgs, msg, RAWIMU)() {
  return get_message_type_support_handle<novatel_oem7_msgs::msg::RAWIMU>();
}
