...
bool novatel_oem7_msgs__msg__ins_frame__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._ins_frame.INSFrame", full_classname_dest, 41) == 0);
  }
  novatel_oem7_msgs__msg__INSFrame * ros_message = _ros_message;
  {  // frame
...
{
  /* NOTE(esteve): Call constructor of INSFrame */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._ins_frame");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "INSFrame");
