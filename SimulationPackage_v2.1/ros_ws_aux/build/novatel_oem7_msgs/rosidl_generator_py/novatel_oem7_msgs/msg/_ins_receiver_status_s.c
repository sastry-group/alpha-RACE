...
bool novatel_oem7_msgs__msg__ins_receiver_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._ins_receiver_status.INSReceiverStatus", full_classname_dest, 60) == 0);
  }
  novatel_oem7_msgs__msg__INSReceiverStatus * ros_message = _ros_message;
  {  // status
...
{
  /* NOTE(esteve): Call constructor of INSReceiverStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._ins_receiver_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "INSReceiverStatus");
