...
bool novatel_oem7_msgs__msg__imuratecorrimu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._imuratecorrimu.IMURATECORRIMU", full_classname_dest, 52) == 0);
  }
  novatel_oem7_msgs__msg__IMURATECORRIMU * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of IMURATECORRIMU */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._imuratecorrimu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "IMURATECORRIMU");
