...
bool novatel_oem7_msgs__msg__solution_source__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._solution_source.SolutionSource", full_classname_dest, 53) == 0);
  }
  novatel_oem7_msgs__msg__SolutionSource * ros_message = _ros_message;
  {  // source
...
{
  /* NOTE(esteve): Call constructor of SolutionSource */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._solution_source");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SolutionSource");
