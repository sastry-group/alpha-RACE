...
bool novatel_oem7_msgs__msg__rotational_offset__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._rotational_offset.RotationalOffset", full_classname_dest, 57) == 0);
  }
  novatel_oem7_msgs__msg__RotationalOffset * ros_message = _ros_message;
  {  // offset
...
{
  /* NOTE(esteve): Call constructor of RotationalOffset */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._rotational_offset");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RotationalOffset");
