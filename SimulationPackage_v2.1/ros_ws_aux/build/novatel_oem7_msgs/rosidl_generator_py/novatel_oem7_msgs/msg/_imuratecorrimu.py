...
class Metaclass_IMURATECORRIMU(type):
    """Metaclass of message 'IMURATECORRIMU'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'novatel_oem7_msgs.msg.IMURATECORRIMU')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__imuratecorrimu
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__imuratecorrimu
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__imuratecorrimu
            cls._TYPE_SUPPORT = module.type_support_msg__msg__imuratecorrimu
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__imuratecorrimu
...
class IMURATECORRIMU(metaclass=Metaclass_IMURATECORRIMU):
    """Message class 'IMURATECORRIMU'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.seconds = kwargs.get('seconds', float())
    ...
    def seconds(self, value):
        if __debug__:
            assert \
                ...
                "The 'seconds' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'seconds' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
        self._seconds = value
