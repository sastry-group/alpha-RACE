...
bool novatel_oem7_msgs__msg__inertial_solution_status__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool novatel_oem7_msgs__msg__inspvax__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("novatel_oem7_msgs.msg._inspvax.INSPVAX", full_classname_dest, 38) == 0);
  }
  novatel_oem7_msgs__msg__INSPVAX * ros_message = _ros_message;
  {  // header
  ...
  {  // ins_status
    ...
    if (!novatel_oem7_msgs__msg__inertial_solution_status__convert_from_py(field, &ros_message->ins_status)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of INSPVAX */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("novatel_oem7_msgs.msg._inspvax");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "INSPVAX");
  ...
  {  // ins_status
    PyObject * field = NULL;
    field = novatel_oem7_msgs__msg__inertial_solution_status__convert_to_py(&ros_message->ins_status);
    if (!field) {
      return NULL;
    }
    {
