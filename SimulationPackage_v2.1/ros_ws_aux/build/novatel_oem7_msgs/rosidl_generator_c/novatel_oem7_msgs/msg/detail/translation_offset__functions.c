...
novatel_oem7_msgs__msg__TranslationOffset__create()
{
  ...
  novatel_oem7_msgs__msg__TranslationOffset * msg = (novatel_oem7_msgs__msg__TranslationOffset *)allocator.allocate(sizeof(novatel_oem7_msgs__msg__TranslationOffset), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(novatel_oem7_msgs__msg__TranslationOffset));
  bool success = novatel_oem7_msgs__msg__TranslationOffset__init(msg);
  if (!success) {
...
novatel_oem7_msgs__msg__TranslationOffset__destroy(novatel_oem7_msgs__msg__TranslationOffset * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    novatel_oem7_msgs__msg__TranslationOffset__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
novatel_oem7_msgs__msg__TranslationOffset__Sequence__init(novatel_oem7_msgs__msg__TranslationOffset__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  novatel_oem7_msgs__msg__TranslationOffset * data = NULL;

  if (size) {
    data = (novatel_oem7_msgs__msg__TranslationOffset *)allocator.zero_allocate(size, sizeof(novatel_oem7_msgs__msg__TranslationOffset), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = novatel_oem7_msgs__msg__TranslationOffset__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        novatel_oem7_msgs__msg__TranslationOffset__fini(&data[i - 1]);
      }
...
novatel_oem7_msgs__msg__TranslationOffset__Sequence__fini(novatel_oem7_msgs__msg__TranslationOffset__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      novatel_oem7_msgs__msg__TranslationOffset__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  novatel_oem7_msgs__msg__TranslationOffset__Sequence * array = (novatel_oem7_msgs__msg__TranslationOffset__Sequence *)allocator.allocate(sizeof(novatel_oem7_msgs__msg__TranslationOffset__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = novatel_oem7_msgs__msg__TranslationOffset__Sequence__init(array, size);
  if (!success) {
...
novatel_oem7_msgs__msg__TranslationOffset__Sequence__destroy(novatel_oem7_msgs__msg__TranslationOffset__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    novatel_oem7_msgs__msg__TranslationOffset__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
novatel_oem7_msgs__msg__TranslationOffset__Sequence__are_equal(const novatel_oem7_msgs__msg__TranslationOffset__Sequence * lhs, const novatel_oem7_msgs__msg__TranslationOffset__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!novatel_oem7_msgs__msg__TranslationOffset__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  novatel_oem7_msgs__msg__TranslationOffset__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(novatel_oem7_msgs__msg__TranslationOffset);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    novatel_oem7_msgs__msg__TranslationOffset * data =
      (novatel_oem7_msgs__msg__TranslationOffset *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!novatel_oem7_msgs__msg__TranslationOffset__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          novatel_oem7_msgs__msg__TranslationOffset__fini(&output->data[i]);
        }
        return false;
      }
    }
